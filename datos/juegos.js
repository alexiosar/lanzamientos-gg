const JUEGOS = [
  {
    ...
    descripcion: "Un RPG narrativo con vista cenital en el que se encarna a un noble menor del siglo XVIII que se mete en la nigromancia buscando conocimiento y venganza. Hay un libro de hechizos con ritos de muerte y reanimación para descifrar, más de 180 personajes con los que hablar y unas 400.000 palabras de texto. Todo pasa por la confianza del pueblo: se investiga, se negocia, se presiona y se adula, y si esa confianza cae demasiado, el final es un juicio y la horca, o una turba enfurecida.",
  ...
  },
  {
    ...
    descripcion: "La historia paralela de Undertale, con el mismo sistema de siempre: en cada pelea se puede luchar o perdonar. Se recorre un mundo misterioso junto a personajes nuevos y otros que ya estaban de los capítulos anteriores.",
  ...
  },
  {
    ...
    descripcion: "El simulador de comprar casas destruidas, arreglarlas y venderlas con ganancia, ahora remasterizado. Se limpia, se construye y se decora sin ayuda de nadie. Esta versión trae mejores gráficos, voces y todas las expansiones juntas, más algunos agregados.",
    trailer: "https://youtube.com/embed/1cDEhGmiSSc",
    metacritic: 72,
    metacriticUsuarios: null,
    critica: "Las cinco reseñas dicen casi lo mismo y con la misma división: para el que nunca jugó, esta colección es la mejor forma de entrar, con todo el contenido adicional adentro y un lavado de cara que se nota. Para el que ya lo tenía, no hay motivo suficiente para volver. Aparecen además dos reparos concretos: quedaron errores sin corregir, y varias reseñas recuerdan que House Flipper 2 ya existe y es mejor juego.",
    imagen: "https://cdn2.steamgriddb.com/grid/292bca5095a601950ba874923a2cd278.png",
    noticias: [
      {
        fecha: "2026-06-24",
  ...
  },     
  {
    ...
    descripcion: "Una versión nueva de Star Fox 64 con todo rehecho: diseños de personajes, niveles, escenas con voces completas y banda sonora orquestal. Se pilotea el Arwing por el sistema Lylat para frenar a Andross, con giros y maniobras para sacarse de encima a los enemigos, y con rutas alternativas que cambian las misiones de una partida a otra. Suma un multijugador de cuatro contra cuatro, controles tipo mouse con los Joy-Con 2 y funciones nuevas con GameChat.",
  ...
  },  
  {
    ...
    descripcion: "Recién mudado a una casa nueva, el protagonista se convierte en ratón, y la única forma de romper la maldición es librar a todo el edificio de sus fantasmas. Cada departamento tiene uno distinto, y como se alimentan de emociones negativas, para encontrarlos hay que investigar a fondo las inseguridades de cada vecino. Un roedor que se hace llamar Jefe es el que guía.",
  ...
  },
  {
    ...
    descripcion: "Un survival horror hecho a la manera de los de PlayStation 1, con la trilogía original de Resident Evil como referencia directa: puzles, combates tensos y mucha atmósfera, pero con controles y cinemáticas actuales. Se juega como agente de un grupo de operaciones encubiertas que va tras Victor, un exagente de la CIA cuyos experimentos llenaron un pueblo perdido de monstruos y personas controladas mentalmente.",
  ...
  },
  {
    ...
    descripcion: "Una aventura de exploración con un gecko que trepa por cualquier superficie. Se escalan ruinas al sol, se cruzan cuevas y se navega en un barquito diminuto entre islas, cada una con sus secretos y restos de una civilización perdida.",
    trailer: "https://youtube.com/embed/Vw2I2y6B2vM",
    metacritic: 73,
    metacriticUsuarios: 7.1,
    metacriticVotos: 13,
    critica: "Todas las reseñas coinciden en el ambiente: es un juego calmo y precioso, y trepar paredes como una lagartija cambia por completo cómo se explora. La discusión es si eso alcanza. Para las notas más altas es el juego perfecto para una tarde tranquila. Para las más bajas nunca termina de encajar: los puzzles se repiten, el movimiento tan generoso le saca toda la tensión al plataformeo, y quedan problemas técnicos sin resolver.",
  ...
  },
  {
    ...
    descripcion: "Un puzle en 3D con los personajes de los arcade de Namco de los ochenta pasados a vóxeles. Se lanzan, se apilan y se fusionan bloques buscando la puntuación más alta.",
    trailer: "https://youtube.com/embed/Zx4ejRlUjq0",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc846.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-06-23"
  },
  {
    ...
    descripcion: "El Monopoly de Hasbro con Star Wars y en versión multijugador, con escenas animadas, casillas temáticas y eventos que cambian cada partida. Se arman equipos de héroes y villanos de la saga, cada uno con habilidades propias que pueden torcer la estrategia en cualquier tirada.",
    ...
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cobzwc.jpg",
    noticias: [
      {
        fecha: "2026-07-01",
  ...
  },
  {
    ...
    descripcion: "Un juego tranquilo de decorar habitaciones donde los objetos que se eligen cambian la historia. Arranca en la infancia eligiendo juguetes que representan sueños, y esos sueños se siguen hasta la adultez, con historias de amor, desamor y pérdida. Se pueden prender luces, hojear libros y acariciar animales, lo que se junta en la historia pasa a un modo creativo sin límites, y al terminar se puede volver al principio para encontrar otros finales.",
  ...
  },
  {
    ...
    descripcion: "Un juego cooperativo de manejar una casa rodante con amigos. Volviendo de vacaciones, el grupo tiene que desviarse por el interior y encontrar la salida a la Ruta 65 atravesando el Valle de Mabutts, del que no todos salen vivos. La casa rodante tiene un malacate adelante y otro atrás, con física real, y con eso se pasa por encima, por abajo o a través de casi cualquier obstáculo.",
  ...
  },
  {
    ...
    descripcion: "La secuela del shooter de humor de Squanch Games. Después de desarmar el cártel intergaláctico de la primera parte, el cazarrecompensas vive cómodo hasta que alguien de su pasado le pone precio a la cabeza de su hermana. Con su equipo de armas alienígenas que hablan, se dispara, se apuñala y se patina por mundos de toda la galaxia contra un conglomerado farmacéutico que quiere lucrar con la vida humana.",
  ...
  },
  {
    ...
    genero: ["MUSICA"],
    desarrollador: "NINTENDO",
    descripcion: "La nueva entrega de Rhythm Heaven, la serie de Nintendo de minijuegos musicales donde todo se resuelve apretando un botón en el momento justo.",
  ...
  },
  {
    ...
    descripcion: "Un shooter de vista cenital donde la nave tiene que estar enchufada a un cable para recargarse. Mientras está conectada dispara con toda la potencia, pero el cable limita cuánto se puede mover, y todo el juego es ese equilibrio entre riesgo y energía. Los sectores cambian en cada partida, hay cámara lenta recargable, jefes enormes al final de cada galaxia, más de 250 combinaciones de modificadores de balas y más de diez naves para elegir.",
  ...
  },
  {
    ...
    descripcion: "Una aventura gráfica al estilo de los noventa, con pixel art oscuro y humor negro. William, un escritor joven que busca su primer éxito, llega a una abadía donde todos hicieron voto de silencio, y lo que empieza como búsqueda de inspiración termina en un secreto que nadie tenía que descubrir. Se explora la abadía y se resuelven puzles con los objetos que se van encontrando.",
    trailer: "https://youtube.com/embed/jzGaNwxPVIY",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coaavy.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-06-30"
  },
  ...
  },
  {
    ...
    descripcion: "La secuela de Wall World: se baja por dentro de un muro misterioso con una araña robot, juntando artefactos y tecnología para mejorar el traje y el vehículo, y peleando contra los monstruos de las profundidades hasta llegar al fondo.",
  ...
  },
  {
    ...
    descripcion: "Un simulador de vida de pueblo en el que se es un vampiro, hijo del Conde Drácula, que quiere demostrarle a su padre que se puede vivir con compasión incluso estando muerto. Hay granja, pero se cultivan cosechas malditas, como calabazas y belladona, porque es lo que come un vampiro. Se hacen amigos entre hombres lobo, brujas y sirenas, se busca pareja, se desbloquean poderes y se preparan pociones mientras se investiga a las siete familias del pueblo.",
  ...
  },
  {
    ...
    metacriticVotos: 9,
    critica: "Las reseñas coinciden en separar la historia del juego. La historia —el regimiento de Terranova en Galípoli, un episodio de la Primera Guerra que casi nadie cuenta— se lleva elogios muy fuertes: hay una nota que dice que debería enseñarse en las escuelas. Lo jugable es otra cosa: casi todas las reseñas hablan de mecánicas repetitivas y hasta innecesarias, que estiran una obra que además es corta. La recomendación que más se repite es jugarlo por lo que cuenta, no por cómo se juega.",
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coblls.jpg",
    noticias: [
      {
        fecha: "2026-07-07",
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coca21.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-07"
  },
  {
    ...
    descripcion: "Ruleta rusa con una escopeta calibre 12: cuatro jugadores entran y uno solo sale. El fenómeno indie de terror llega a Xbox con su modo multijugador para cuatro.",
  ...
  },
  {
    ...
    descripcion: "La aventura pirata de Assassin's Creed, rehecha desde cero con la versión más reciente del motor Anvil. Se juega como Edward Kenway, capitán del Jackdaw: se abordan y se hunden barcos, se alterna entre sigilo en la multitud y peleas abiertas con espadas, pistolas y la Hoja Oculta, y se cruzan piratas históricos en medio de la guerra entre Asesinos y Templarios.",
  ...
  },
  {
    ...
    descripcion: "Un RPG de acción en Aincrad, el castillo flotante de Sword Art Online, donde cada pelea puede ser la última. Se crea el personaje, se elige el equipo y se combate a fuerza de habilidades y reflejos, sincronizando ataques con un compañero y subiendo de nivel para desbloquear técnicas más fuertes.",
  ...
  },
  {
    ...
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocc79.jpg",
    noticias: [
      {
        fecha: "2026-07-21",
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/996179fb4d3db8777f6f5c83706f634a.png",
    gamepass: false,
    psplus: false,
    alta: "2026-07-07"
  },
  ...
  },
  {
    ...
    descripcion: "Un juego de supervivencia y gestión al frente de un asentamiento vikingo. Se junta material, se construye, se fabrica, se caza y se saquea, siempre con los dioses de por medio, para que el clan aguante la dureza de la naturaleza.",
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc941.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-07"
  },
  ...
  },
  {
    ...
    imagen: "https://cdn2.steamgriddb.com/grid/2201184c174084c9e455a23931a34287.jpg",
    noticias: [
      {
        fecha: "2026-07-14",
  ...
  },
  {
    ...
    descripcion: "Una aventura en las páginas de un libro de cuentos viviente, lleno de mitos y magia antigua, con Quill, una ratoncita chiquita pero decidida. Es la primera entrega de la saga, nacida en realidad virtual, reconstruida desde cero para jugarse en consolas sin visor.",
  ...
  },
  {
    ...
    duracion: "≈ 29 h (historia) · 68 h (completo)",
    ...
    metacritic: 79,
    critica: "Pocas reseñas y coinciden en lo mismo: es un juego de naves con exploración y combate que no intenta ser Mass Effect ni No Man's Sky, y varias dicen que ahí está el acierto. Esta edición junta el juego con todo su contenido descargable, y ese paquete es la mitad del argumento a favor. El reparo que aparece es de ritmo: las misiones de puzles no están a la altura de las de acción, y moverse por el mundo se siente algo tosco.",
    metacriticUsuarios: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1128920/library_600x900.jpg",
    noticias: [
      {
        fecha: "2026-09-01",
        titulo: "DEBUTA CON 79",
  ...
  },
  {
    ...
    duracion: "≈ 7,1 h (historia) · 10 h (completo)",
    fecha: "2026-08-18",
    plataformas: ["SWITCH"],
    genero: ["RPG", "AVENTURA", "INDIE", "POR TURNOS"],
    desarrollador: "DARYA NOGHANI",
    descripcion: "Debajo de las calles de Londres, un ratón furioso sale a buscar venganza contra el dios que le robó la cola. Es un RPG épico en escala de juguete: los héroes son roedores, las armas son cubiertos y las mazmorras son alcantarillas y sótanos, con una escritura que se toma en serio a sus personajes aunque midan cinco centímetros.",
  ...
  },
  {
    ...
    descripcion: "Una mezcla de novela visual y juego de ritmo ambientada en un inframundo de perros. Se busca a un cachorro perdido conectando con las almas de otros perros, conociendo sus historias y levantándoles el ánimo con minijuegos musicales. La banda sonora la hacen los compositores de To the Moon y Friday Night Funkin'.",
    trailer: "https://youtube.com/embed/mGQ_sVCc1_c",
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/ec291433da1071ef8ff16b79bd26f32b.jpg",
    noticias: [
      {
        fecha: "2026-07-21",
  ...
  },
  {
    ...
    descripcion: "Un constructor de ciudades en el que se es un alcalde que pone las manos: se planifican barrios, se automatiza la logística y se lidia con obreros e infraestructura. Se juega solo o en cooperativo con amigos. La versión 1.0 debuta en Switch y Switch 2 tras su paso por acceso anticipado.",
  ...
  },
  {
    ...
    genero: ["FPS", "ACCION", "SHOOTER", "INDIE"],
    desarrollador: "MAETH",
    ...
    noticias: [
      {
        fecha: "2026-09-08",
        titulo: "DEBUTA CON 75: UN SHOOTER DE LOS DE ANTES",
        texto: "Sale hoy en PS5, Xbox y Switch 2 la precuela de SPRAWL, y las reseñas coinciden en que MAETH sabe lo que hace: correr, agarrar un arma, vaciarla y tirarla. Es más lento que el anterior, con bala lenta y guantes de gravedad en lugar del parkour. Le señalan enemigos que frenan el combate y una historia floja."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    descripcion: "El mundo lee la Divina Comedia como un poema; para tu familia es una condena. Sos Gabriele Alighieri y te toca sellar las puertas del Infierno. Es una pesadilla psicológica en primera persona donde hay que reconstruir los secretos de tus antepasados para sobrevivir a lo que te tocó heredar.",
    trailer: "https://youtube.com/embed/cS6PTKRdkuk",
    metacritic: 63,
  ...
  {
    id: "truck-kun-is-supporting-me-from-another-world-switch-2",
    titulo: "TRUCK-KUN IS SUPPORTING ME FROM ANOTHER WORLD?!",
    relanzamiento: "En Xbox y PC desde el 29 de julio de 2026 — esta fecha corresponde a la edición de Switch 2",
    duracion: "≈ 3,5 h (historia) · 6,9 h (completo)",
    fecha: "2026-09-14",
    plataformas: ["SWITCH2"],
    genero: ["ACCION", "ANIME", "INDIE"],
    desarrollador: "STRANGE SCAFFOLD",
    descripcion: "La edición de Switch 2 del juego que convierte en mecánica el chiste más repetido del anime: el camión que atropella al protagonista y lo manda a otro mundo, manejado por vos. Llega mes y medio después del estreno en Xbox, con el mismo contenido.",
    trailer: "https://youtube.com/embed/Iujy19OLvuc",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc030.jpg",
    noticias: [
      {
        fecha: "2026-08-20",
        titulo: "CONFIRMADA LA EDICIÓN DE SWITCH 2 PARA EL 14 DE SEPTIEMBRE",
  ...
  },
  {
    ...
    duracion: "≈ 11 h (historia)",
    fecha: "2026-09-14",
    plataformas: ["PS5", "XBOX"],
    genero: ["FPS", "ACCION", "SUPERVIVENCIA", "INDIE"],
    desarrollador: "OMYOG",
    descripcion: "Un shooter en primera persona en una isla donde conviven mercenarios y dinosaurios, y los dos son un problema. Hay que sobrevivir en un ecosistema hostil y los tiroteos se arman en medio de la selva. Es de un solo jugador y lo publica tinyBuild.",
    trailer: "https://youtube.com/embed/tAh1gguX0jc",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1645630/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-14"
  },
  {
    id: "beyblade-x-evobattle",
    titulo: "BEYBLADE X EVOBATTLE",
    relanzamiento: "En Switch y PC desde noviembre de 2025, y en Switch 2 desde enero de 2026 — esta fecha corresponde a la edición de PS5",
    duracion: "≈ 12 h (historia)",
    fecha: "2026-09-14",
    plataformas: ["PS5"],
    genero: ["ACCION", "ANIME", "CASUAL"],
    desarrollador: "GROOVE BOX JAPAN",
    descripcion: "El juego oficial de Beyblade X, basado en el animé y en los trompos de juguete de TOMY. Se arman trompos pieza por pieza, se lanzan en el estadio y hay un modo historia además del combate online. Llega a PS5 casi un año después de Switch.",
    trailer: "https://youtube.com/embed/n2Zs-xwzSyI",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coao9p.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-14"
  },
  {
    ...
    duracion: "≈ 3 h (historia) · 5 h (completo)",
    fecha: "2026-09-16",
    plataformas: ["PS5", "XBOX"],
  ...
  },
  {
    ...
    duracion: "≈ 15 h (historia) · 32 h (completo)",
    fecha: "2026-09-22",
    plataformas: ["XBOX"],
  ...
  },
  {
    id: "sin-reloaded",
    titulo: "SIN: RELOADED",
    duracion: "≈ 7,2 h (historia) · 12 h (completo)",
    relanzamiento: "Remasterización del juego de 1998",
    fecha: "2026-09-24",
    plataformas: ["PS5", "PS4", "SWITCH", "XBOX"],
    genero: ["FPS", "ACCION", "SHOOTER", "RETRO"],
  ...
  },
  {
    ...
    descripcion: "Sos una guitarra con conciencia atrapada en una escuela de música que se volvió pesadilla. Hay que esconderse, distraer a lo que anda suelto y resolver puzzles musicales para ir juntando los pedazos de una memoria rota y entender qué pasó ahí adentro.",
  ...
  },
  {
    ...
    fecha: "2026-10-01",
    plataformas: ["PS5", "SWITCH2", "XBOX"],
    genero: ["ACCION", "AVENTURA", "HORROR", "RPG"],
  ...
  {
    id: "warhammer-40000-boltgun-2",
    titulo: "WARHAMMER 40,000: BOLTGUN 2",
    fecha: "2026-10-14",
    plataformas: ["PS5", "XBOX"],
    genero: ["FPS", "ACCION", "RETRO"],
    desarrollador: "AUROCH DIGITAL",
    descripcion: "La secuela del shooter retro de Warhammer 40,000, con la estética de los FPS de los noventa. Esta vez hay dos personajes para elegir, cada uno con sus armas y su forma de jugar: Malum Caedo, el marine de la primera parte, o Nyra Veyrath, una hermana de batalla más ágil. La campaña tiene caminos que se ramifican.",
  ...
  },
  {
    ...
    imagen: "https://cdn2.steamgriddb.com/grid/28eeb4998e282cee80f46cd5a67b7e30.png",
    noticias: [
      {
        fecha: "2026-07-17",
        titulo: "DEBUT CON 82 EN METACRITIC",
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc3sq.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-09"
  },
  {
    ...
    descripcion: "Un simulador de representante de un grupo de K-pop. Se reclutan talentos, se arma la agenda, se elige el vestuario, se planifican las publicaciones y se prepara el lanzamiento del disco, con el objetivo de que el grupo llegue a debutar.",
  ...
  },
  {
    ...
    descripcion: "Un juego de granja en un planeta propio, comprado casi regalado en las afueras de la galaxia. La idea es dejar atrás la ciudad superpoblada y empezar una vida rural cultivando esa roca.",
  ...
  },
  {
    ...
    descripcion: "Un cooperativo para cuatro jugadores de terror de extracción en el Triángulo de las Bermudas. Todo gira alrededor de un único vehículo compartido y de una física caótica que vuelve las leyes de la naturaleza en contra del grupo, entre gritos y risas.",
    trailer: "https://youtube.com/embed/UIoMzMEyctg",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc0b9.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-09"
  },
  ...
  },
  {
    ...
    descripcion: "Un juego de mountain bike hecho por ciclistas, con controles de doble stick pensados para trucos grandes. Se anda con amigos o se compite en tablas mundiales, y superando desafíos se consiguen patrocinios de marcas reales.",
  ...
  },
  {
    ...
    descripcion: "Un juego de pelea con los personajes de Avatar y sus poderes elementales, con animación 2D dibujada a mano que respeta el estilo de la serie.",
  ...
  },
  {
    ...
    imagen: "https://cdn2.steamgriddb.com/grid/1edcd79700025b392154e6c4a99e719e.jpg",
    noticias: [
      {
        fecha: "2026-07-23",
  ...
  },
  {
    ...
    descripcion: "Un juego de acción exigente, con combates rápidos y jefes que se pueden enfrentar en el orden que se quiera. Cada jefe vencido entrega su poder, y con eso se arma el camino propio.",
  ...
  },
  {
    ...
    descripcion: "Una aventura de puzles en Helix, un mundo olvidado donde despiertan poderes antiguos. Se combinan habilidades para descifrar lo que dejó una civilización perdida, bajando a las profundidades y volviendo a subir a la luz.",
  ...
  },
  {
    ...
    descripcion: "Unos alienígenas secuestraron a las gallinas y Dodo, un pato valiente pero distraído, sale a rescatarlas. El truco es que se puede cambiar al instante entre vista 2D y 3D para resolver los puzles de plataformas, en un mundo simpático donde hasta hay un carpincho que vende gorras.",
    ...
    critica: "Las cuatro reseñas se dividen justo al medio y por eso el 81 engaña un poco. Las dos entusiastas destacan la idea central, que es alternar entre 2D y 3D como base del diseño de niveles, y dicen que no se queda en el truco: el juego que se construye encima funciona. Las dos tibias dicen lo mismo del mecanismo pero se topan con errores: uno de los medios lo señala como el motivo directo de su nota. Si el estudio los corrige, la diferencia entre las dos mitades se achica sola.",
    noticias: [
      {
        fecha: "2026-09-07",
        titulo: "DEBUTA CON 81 ALTERNANDO ENTRE 2D Y 3D",
        texto: "La idea es cambiar de perspectiva entre dos y tres dimensiones, y las cuatro reseñas coinciden en que el diseño de niveles la aprovecha de verdad. Dos de las cuatro le bajan la nota por errores técnicos, no por el diseño."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    descripcion: "Un simulador de pool con física realista y control preciso. Trae bola 8, bola 9 y otras modalidades, se juega solo, en local u online con juego cruzado, y suma un modo carrera largo y muchas opciones de personalización.",
    trailer: "https://youtube.com/embed/a7_0PDYg7y4",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coakle.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-10"
  },
  {
    ...
    descripcion: "Un juego de supervivencia en primera persona sobre una Tierra arrasada. Se vive arriba, en una aeronave que se construye y se mejora, y se baja a la superficie a juntar materiales mientras se busca una cura para la humanidad. Se juega solo o con hasta tres amigos.",
  ...
  },
  {
    ...
    fecha: "2026-10-15",
    plataformas: ["PS5"],
    genero: ["ACCION", "ROGUELIKE", "COOP", "INDIE"],
    desarrollador: "FEATHERWEIGHT GAMES",
    descripcion: "Un roguelite cooperativo de gladiadores para uno a cuatro jugadores, con la vuelta de que todos están encadenados entre sí. Se pelea en el Coliseo usando el escenario, de pinchos a pozos con serpientes, y se tiran armas, urnas y enemigos. Las heridas cambian cómo se juega, y hay que ganarse al público para conseguir la libertad.",
    trailer: "https://youtube.com/embed/J5KKhsI1QL8",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coad6n.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-17"
  },
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc1hl.jpg",
    noticias: [
      {
        fecha: "2026-08-24",
        titulo: "NO SALIÓ EN JULIO: LA EDICIÓN FÍSICA LLEGA EN OCTUBRE",
        texto: "Teníamos la fecha mal. Strictly Limited Games, que es quien la edita, dice octubre de 2026 sin día exacto. Es una edición física y limitada: no está ni en la PlayStation Store ni en la eShop, se compra en la tienda del editor, en versiones Limited y Deluxe para PS5 y Switch."
      },
      {
        fecha: "2026-07-29",
  ...
  },
  {
    ...
    genero: ["ACCION", "ANIME", "INDIE"],
    desarrollador: "STRANGE SCAFFOLD",
    descripcion: "Un juego de manejo caótico que se burla del chiste más repetido del anime: el camión que atropella al protagonista y lo manda a otro mundo. Acá se maneja ese camión, con el alma empeñada a una elfa que vive en la cabeza del conductor, y se atropellan peatones, se hacen entregas y se pelea contra un rey esqueleto en dos mundos. Está pensado para reintentar una y otra vez.",
    trailer: "https://youtube.com/embed/Iujy19OLvuc",
    metacritic: 69,
    metacriticUsuarios: null,
  ...
  },
  {
    ...
    descripcion: "Toda la serie Blue Reflection junta en un solo paquete: los RPG de Gust sobre las Reflectors, chicas con poderes mágicos, y los vínculos entre ellas.",
    trailer: "https://youtube.com/embed/cgJHujvxg0s",
    metacritic: 76,
    metacriticUsuarios: 5.4,
    metacriticVotos: 9,
    critica: "La colección junta cuatro cosas y las reseñas coinciden en que no valen lo mismo. Los dos juegos originales se llevan los elogios: historias sobre crecer, contadas con calma, que a varios medios les parecen de lo mejor del estudio. Las adaptaciones del anime y del juego para celular son el problema, y aparecen descritas como flojas o hechas a medias en casi todas las notas. El otro reparo repetido es técnico: el lavado de cara se quedó corto.",
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocaud.jpg",
    noticias: [
      {
        fecha: "2026-07-31",
  ...
  },
  {
    ...
    descripcion: "Un shoot 'em up de naves contra hordas alienígenas, con varios tipos de disparo, entre ellos el rayo Truxton, el láser trueno y los proyectiles guiados, y jefes gigantes en una pelea por la supervivencia de la humanidad.",
    ...
    imagen: "https://cdn2.steamgriddb.com/grid/5b68381cfca7574916fd3341a878623d.png",
    noticias: [
      {
        fecha: "2026-07-30",
  ...
  },
  {
    ...
    descripcion: "Un juego tranquilo de manejar un vivero chico. Se cuidan y se venden plantas de muchas variedades, se ayuda a los clientes a encontrar la que buscan y se decora el local de mil maneras.",
    trailer: "https://youtube.com/embed/zOi4PqrXiO8",
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/c6936f77f9dd8d29c148ebd627b5a624.png",
    gamepass: false,
    psplus: false,
    alta: "2026-07-10"
  },
  {
    ...
    descripcion: "Un roguelite de hordas donde se arma un escuadrón de criaturas elementales. Los Fragmentos que se eligen dan habilidades nuevas según cómo combinen entre sí, y las reliquias terminan de definir la partida en cada escenario.",
  ...
  },
  {
    ...
    descripcion: "Un RPG inspirado en la saga King's Field. Pasa después de la Era de la Soledad, cuando una maldición borra las caras y las máscaras son la única protección, y se viaja a Yariv a buscar su origen.",
  ...
  },
  {
    ...
    descripcion: "Un juego de las Winx con combate mágico y puzles. Se juega con las seis integrantes del club, cada una con sus propias habilidades.",
    trailer: "https://youtube.com/embed/VR0i6lthTDM",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cobhh6.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-14"
  },
  {
    ...
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coay84.jpg",
    noticias: [
      {
        fecha: "2026-07-31",
  ...
  },
  {
    ...
    desarrollador: "ALAWAR",
    descripcion: "Un spin-off de Beholder, la serie de vigilar a los demás en un régimen autoritario. Esta vez se es el conductor de un tren: se controla a los pasajeros, se denuncian incidentes y se cumplen misiones para el Ministerio, que sólo acepta resultados.",
  ...
  },
  {
    ...
    descripcion: "La remasterización del western de disparos de LucasArts. Unos forajidos mataron a la esposa del protagonista y se llevaron a su hija, y la historia es la venganza.",
    trailer: "https://youtube.com/embed/qzB7qpClDpE",
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/0b81d371977576d321192d283dea06c9.png",
    gamepass: false,
    psplus: false,
    alta: "2026-07-14"
  },
  ...
  },
  {
    ...
    fecha: "2026-07-24",
    relanzamiento: "En PC desde 2025",
    duracion: "≈ 22 h (historia)",
    plataformas: ["XBOX", "PS5"],
    genero: ["ACCION", "AVENTURA", "INDIE"],
    desarrollador: "HIT START STUDIOS",
    descripcion: "Un plataformas cooperativo pensado para superarse en equipo, escapando de niveles cada vez más exigentes junto a amigos.",
  ...
  },
  {
    ...
    descripcion: "En un Japón posapocalíptico, la última esperanza de la humanidad son Emma y Koo, su perro. Es el primer gran RPG de acción de Game Freak, los creadores de Pokémon, con combates técnicos y exigentes.",
  ...
  },
  {
    ...
    descripcion: "Un juego cooperativo online de salir a caminar con amigos y perderse en un mundo enorme, hecho por los creadores de Untitled Goose Game.",
  ...
  },
  {
    ...
    descripcion: "Un juego de pelea de equipos de cuatro contra cuatro con personajes de Marvel, hecho por Arc System Works junto a PlayStation Studios y Marvel Games.",
  ...
  },
  {
    ...
    descripcion: "Un roguelite de supervivencia y defensa de torres donde la ciudad que se protege va sobre ruedas. Se juntan recursos, se refuerzan las defensas y se mejora todo mientras las hordas avanzan, con la meta de llegar al Arco a tiempo.",
    trailer: "https://youtube.com/embed/P33pMKtwmLE",
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/b82959244a8d32cfb974a8e330e8f38a.png",
    gamepass: true,
    psplus: false,
    alta: "2026-07-14"
  },
  {
    ...
    descripcion: "La vuelta de Route-16 Turbo, un juego de NES de hace más de cuarenta años, con la jugabilidad original intacta, gráficos rehechos por completo y algunos agregados.",
    trailer: "https://youtube.com/embed/Gi-5BgQe9yU",
    metacritic: null,
  ...
  },
  {
    ...
    descripcion: "Un roguelike de construcción de mazos y captura de criaturas. Se domestican y coleccionan Montabi, se arma un equipo buscando sinergias entre sus habilidades y se pelea por turnos para salvar la ciudad.",
  ...
  },
  {
    ...
    descripcion: "La remasterización de Oblivion, con Cyrodiil reconstruida gráficamente y ajustes en la jugabilidad. Esta edición lleva el remaster a Switch 2 por primera vez.",
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/30b833400408d4136967abd6a146f828.png",
    noticias: [
      {
        fecha: "2026-08-11",
  ...
  },
  {
    ...
    imagen: "https://cdn2.steamgriddb.com/grid/2aaac82aeb62f794b2cebd283acdf22b.png",
    noticias: [
      {
        fecha: "2026-08-13",
  ...
  },
  {
    ...
    descripcion: "Un simulador de tanques de estética anime al frente de un pelotón alemán en la Segunda Guerra Mundial. Se arma la tripulación, se eligen tanques históricos y se gana más con astucia que con fuerza. La Commander's Edition trae el juego a consolas.",
  ...
  },
  {
    ...
    descripcion: "Un tower defense roguelike donde el mapa se construye mientras se defiende la fortaleza de una invasión alienígena. Hay treinta héroes para elegir y torres que se van mejorando oleada tras oleada.",
  ...
  },
  {
    ...
    descripcion: "La secuela independiente del RPG de acción Mortal Shell, con peleas despiadadas. Se sigue poseyendo el cuerpo de guerreros caídos para combatir, ahora contra dioses falsos en un mundo que se desmorona.",
  ...
  {
    id: "pipistrello-and-the-cursed-yoyo",
    titulo: "PIPISTRELLO AND THE CURSED YOYO",
    relanzamiento: "En PS5, PS4, Xbox, Switch y PC desde mayo de 2025 — esta versión de Switch 2 es una mejora gratuita de la de Switch",
    duracion: "≈ 14 h (historia) · 21 h (completo)",
    fecha: "2026-08-20",
    plataformas: ["SWITCH2"],
    genero: ["ACCION", "AVENTURA", "PLATAFORMA", "INDIE"],
    desarrollador: "POCKET TRAP",
    descripcion: "Una aventura de plataformas en dos dimensiones y vista cenital donde el arma es un yoyó. Sos Pippit, heredero de una familia venida a menos, y te toca recuperar el imperio de tu tía a los yoyazos, enfrentando a cuatro jefes del crimen repartidos por los barrios de la ciudad. Cada truco nuevo cambia la forma de leer el escenario: lo que era una pared se vuelve un atajo, y casi todos los desafíos tienen más de una solución. La edición de Switch 2 corre a 120 cuadros por segundo en modo portátil a 1080p, llega a 4K en el dock y suma HDR.",
    trailer: "https://youtube.com/embed/Xvtfx9WccCg",
    metacritic: 87,
    metacriticUsuarios: 8.3,
    metacriticVotos: 67,
    ...
    noticias: [
      {
        fecha: "2026-08-20",
        titulo: "DEBUTA CON 87 EN SU LLEGADA A SWITCH 2",
        texto: "La versión de Switch 2 sale hoy como mejora gratuita de la de Switch, con 120 cuadros por segundo en portátil y 4K en el dock. La prensa lo recibió con 87: el yoyó que sirve de arma y de gancho es lo que más se elogia."
      }
    ]
  },
  {
    id: "iracing-arcade",
    titulo: "IRACING ARCADE",
    relanzamiento: "En PC desde marzo de 2026",
    fecha: "2026-08-21",
    plataformas: ["PS5", "XBOX"],
    genero: ["CARRERAS", "ARCADE", "SIMULACION"],
    desarrollador: "ORIGINAL FIRE GAMES",
    ...
    noticias: [
      {
        fecha: "2026-08-21",
        titulo: "DEBUTA CON 72: DIVERTIDO, PERO NO ES UN IRACING",
        texto: "Sale hoy en PS5 y Xbox con 72 de crítica. La prensa coincide en que funciona como puerta de entrada a las carreras —autos con licencia en miniatura, fácil de agarrar, modo carrera largo— y en que la conducción quedó demasiado simplificada para el nombre que lleva."
      }
    ]
  },
  {
    ...
    descripcion: "Un juego de rol y aventura en 2D donde se es una bruja con panadería en París. Se atiende la tienda, se recorren calles conocidas de la ciudad y se reconforta a la gente con lo que sale del horno.",
  ...
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-07",
        titulo: "ENTRA A GAME PASS",
        texto: "Xbox lo anunció en su blog: el survival de mundo compartido está en Game Pass desde ayer, con beneficios propios para los suscriptores. Es gratuito de por sí, así que lo que suma la suscripción son las ventajas de membresía, no el acceso. Tiene juego cruzado y progreso compartido entre plataformas."
      },
      {
        fecha: "2026-08-25",
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocdqn.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-14"
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-08-27",
        titulo: "DEBUTA CON 71",
        texto: "La prensa reconoce la profundidad —seis campañas y una gestión de ejércitos muy trabajada— pero la mayoría termina decepcionada. El reproche que se repite es que esta entrega buscó ser más accesible y perdió por el camino lo que hacía de la serie un objeto de culto."
      }
    ],
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cobihe.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-14"
  },
  {
    ...
    descripcion: "La precuela de A Plague Tale, protagonizada por Sofía. Se viaja a la Isla del Minotauro, se esquiva y se supera a los enemigos, y en el centro de una maldición espera una criatura mitológica.",
    ...
    noticias: [
      {
        fecha: "2026-08-27",
        titulo: "DEBUTA CON 79 Y DIVIDE A LA PRENSA",
        texto: "Es el estreno más discutido de la semana: hay reseñas de 95 y de 60. Nadie discute el apartado visual ni la banda sonora de Olivier Derivière; lo que se discute es el giro de la serie hacia la acción, con menos sigilo y menos ratas. Los reparos más repetidos son el arranque lento y el rendimiento."
      },
      {
        fecha: "2026-07-10",
  ...
  },
  {
    ...
    descripcion: "Un juego táctico por turnos para un jugador ambientado al final de las Guerras Clon, al mando de un escuadrón de élite.",
  ...
  },
  {
    ...
    descripcion: "El segundo volumen de la colección de Konami junta Metal Gear Solid 4: Guns of the Patriots y la versión HD de Metal Gear Solid: Peace Walker. Como extra trae la banda sonora en digital y Metal Gear: Ghost Babel.",
    ...
    noticias: [
      {
        fecha: "2026-08-27",
        titulo: "DEBUTA CON 85: MGS4 SALE DE LA PS3 DESPUÉS DE 18 AÑOS",
        texto: "El puntaje se explica casi entero por una razón que aparece en todas las reseñas: Metal Gear Solid 4 dejó de ser exclusivo de PS3 después de dieciocho años. Peace Walker y Ghost Babel completan el paquete. Las críticas apuntan al continente y no al contenido: menos juegos que el Vol. 1 y ningún menú común entre ellos."
      }
    ],
    imagen: "https://cdn2.steamgriddb.com/grid/be9c9692971c6207d224c8df4983e8cd.png",
    gamepass: false,
    psplus: false,
    alta: "2026-07-14"
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-01",
        titulo: "DEBUTA CON 76",
        texto: "La secuela convence a la prensa por lo mismo que el original: es un metroidvania que se siente a los de antes sin sentirse viejo. Se elogian el pixel art de 16 bits y la curva de dificultad. El reparo que aparece es el mapa, poco intuitivo, y la falta de comodidades que hoy se dan por sentadas."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    descripcion: "Una aventura inspirada en el folclore de Madagascar, donde se arma una banda de lémures músicos para salvar la isla de la bruja Raneny. Se recorre Lemuria rescatando lémures artistas, y la música es el arma.",
    trailer: "https://youtube.com/embed/Bg_sHaq1u3I",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cobys5.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-14",
    noticias: [
  ...
  },
  {
    ...
    descripcion: "El nuevo juego de fútbol de Captain Tsubasa, con 110 personajes y supermovimientos nuevos. Hay modo historia siguiendo a Tsubasa y partidos contra amigos.",
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://assets.nintendo.eu/image/private/f_auto,q_auto,w_500/poj0vpjjjjth3ruowu1h",
    gamepass: false,
    psplus: false,
    alta: "2026-07-14"
  },
  {
    ...
    descripcion: "Un RPG de acción y fantasía oscura en mundo abierto, en la Europa del siglo XIV. Coen es humano de día y vampiro de noche, pelea por salvar a su familia y la historia cambia según sus decisiones.",
    ...
    noticias: [
      {
        fecha: "2026-09-03",
        titulo: "DEBUTA CON 83 Y SE SACA A THE WITCHER DE ENCIMA",
        texto: "Sale hoy en PS5 y Xbox con 83 y más de treinta reseñas. El acuerdo es que el reloj de treinta días y la dualidad humano/vampiro le dan identidad propia; el reparo, que el mundo abierto se siente de fórmula y que la deuda con The Witcher 3 se nota."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-03",
        titulo: "EL MISTERIO DE NINTENDO ERA UN COOPERATIVO PARA DOS, Y DEBUTA CON 82",
        texto: "Se anunció con dos palabras —«We are one!»— y hoy se entiende por qué: es un cooperativo para dos jugadores, sin modo individual. Debuta con 82. Las reseñas lo comparan con It Takes Two y Split Fiction, elogian el diseño de niveles y la estética de anime de los ochenta, y le marcan que la campaña es corta."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    descripcion: "Un plataformas con los Marsupilamis, que tienen que salvar Palombia de la Reina Momia. Una melodía extraña hizo que todos los animales se pusieran a bailar y dieran vuelta la selva.",
    trailer: "https://youtube.com/embed/G8SvJzrpSG0",
    gameplay: {
      video: "https://youtube.com/embed/iv7V-w4T0rE",
      canal: "L0k0hGaming",
      canalUrl: "https://www.youtube.com/@l0k0hgaming"
    },
    metacritic: 81,
    ...
    critica: "Cinco reseñas y un acuerdo tranquilo: es un plataformas 2D prolijo y colorido, fiel a la historieta de Franquin, y de los pocos que se pueden jugar con chicos al lado. Lo que más se destaca es el ritmo y que funciona bien en portátil. Los reparos son de tamaño, no de calidad: es corto, y varias reseñas señalan que el movimiento, la música y el diseño de niveles no siempre encajan al mismo tiempo — cuando lo hacen es muy bueno, cuando no, se siente irregular. Nadie lo trata de imprescindible y nadie lo trata mal.",
    noticias: [
      {
        fecha: "2026-09-07",
        titulo: "DEBUTA CON 79: PLATAFORMAS PROLIJO Y PARA JUGAR ACOMPAÑADO",
        texto: "Las reseñas coinciden en lo colorido y en la fidelidad a la historieta, y en que anda muy bien en portátil. Los reparos son que es corto y que el ritmo no siempre encaja. Sigue siendo de los pocos del mes que se puede jugar con chicos al lado."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-03",
        titulo: "LLEGA A SWITCH 2 EL SOULSLIKE DE TEAM NINJA, CON 80 DE 2023",
        texto: "La edición de Switch 2 sale hoy. El puntaje viene del lanzamiento de 2023 en las otras consolas: un soulslike de los Tres Reinos donde el parry es el centro del combate. Los reparos de entonces siguen valiendo — dificultad despareja y escenarios lineales."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-07",
        titulo: "VENDIÓ UN MILLÓN EL DÍA DE SALIDA",
        texto: "Capcom informó que superó el millón de copias en su primer día. Para una saga que estuvo veinte años sin entregas nuevas, es la señal de que el regreso no era sólo nostalgia: la apuesta le salió."
      },
      {
        fecha: "2026-09-04",
        titulo: "DEBUTA CON 85: VUELVE ONIMUSHA Y LE SALE BIEN",
        texto: "Sale hoy en PS5 y Xbox con 85 y más de cincuenta reseñas. El acuerdo es que el combate es lo mejor que hizo Capcom este año y que hicieron bien en no convertirlo en un soulslike. Los reparos: jefes repetidos, un Kioto abierto que se siente de relleno y una historia floja."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    metacriticUsuarios: 4.5,
    metacriticVotos: 39,
    imagen: "https://cdn2.steamgriddb.com/grid/044cc19989940754a8760f2a713803fc.png",
    critica: "Las veinte reseñas dicen casi lo mismo con distinto entusiasmo: es un regalo para quien sigue el anime y poco más. Lo que se elogia es el volumen —sesenta y ocho personajes jugables, varios modos, y la adaptación del arco final de la Guerra— y las peleas tres contra tres, donde cada personaje se siente distinto. Los reparos también son parejos: la cámara se pierde en los combates, la dificultad está mal repartida, y varios señalan que sigue sin ser el juego definitivo de la serie pese a ser mejor que One's Justice 2. El aviso que aparece en casi todas: si no seguís el anime, no vas a entender nada.",
    noticias: [
      {
        fecha: "2026-09-04",
        titulo: "DEBUTA CON 72, PENSADO PARA QUIEN SIGUE EL ANIME",
        texto: "Adapta el arco final de la Guerra con 68 personajes jugables y peleas de tres contra tres. Las reseñas coinciden en que es generoso en contenido y fiel al material, y en que la cámara y la dificultad le juegan en contra. Casi todas avisan lo mismo: si no seguís el anime, no es para vos."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-08",
        titulo: "DEBUTA CON 72 Y LAS RESEÑAS QUEDAN PARTIDAS",
        texto: "Sale hoy en PS5 y Xbox el asimétrico de IllFonic. Coinciden en que Haddonfield está bien hecho y en que ser Michael Myers cumple, pero le marcan que los sobrevivientes quedaron por detrás, que la inteligencia artificial falla y que las partidas se estiran. La pregunta que se repite es si el estudio va a sostenerlo con actualizaciones."
      }
    ]
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-08",
        titulo: "DEBUTA CON 61: LA MEJOR FLOTA Y EL PEOR ESTADO",
        texto: "Salió en PS5 y Xbox con más de cuarenta y cinco colectivos con licencia y un mapa nuevo inspirado en España y Portugal, y eso las reseñas se lo reconocen. El problema es técnico: coinciden en que se siente inacabado, con errores y una inteligencia artificial del tránsito que arruina el manejo. Varias dicen que con parches puede terminar siendo bueno."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    descripcion: "Un metroidvania de acción en 2D dibujado a mano. Se usan poderes de bestia y una espada que devora corazones para vengarse y frenar la amenaza sobre Arborea, y el final depende de las decisiones que se toman.",
  ...
  },
  {
    ...
    descripcion: "Un juego de plataformas que mezcla 2D y 3D a través de una consola portátil, la Qboy, que abre una segunda realidad. Sus creadores lo presentan como el primer plataformas en 5D.",
  ...
  },
  {
    ...
    gamepass: false,
    psplus: false,
    critica: "Las reseñas coinciden en dos cosas. Que la espera valió la pena, porque este arco estuvo doce años sin traducirse y era el hueco grande para quien sigue la saga en occidente. Y que Crossbell es de los mejores escenarios que armó Falcom: una ciudad apretada entre dos potencias, con una trama política que se toma su tiempo y personajes que casi todas las reseñas destacan. Los reparos son de la edad del juego — misiones secundarias tediosas y decisiones de diseño que envejecieron mal —, porque debajo sigue siendo un juego pensado para una portátil de hace más de una década.",
    alta: "2026-07-16",
    noticias: [
      {
        fecha: "2026-09-10",
        titulo: "DEBUTA CON 80: LLEGA EL ARCO QUE FALTABA",
        texto: "Sale hoy junto a Trails to Azure, su continuación directa. Es el arco de Crossbell, que estuvo doce años sin traducirse y era el agujero grande de la saga en occidente. Las reseñas elogian la trama política y los personajes, y le marcan que el diseño de las misiones secundarias se nota viejo."
      }
    ]
  },
  {
    ...
    genero: ["RPG", "POR TURNOS"],
    desarrollador: "NIHON FALCOM",
    descripcion: "La secuela directa de Trails from Zero. La Sección de Apoyo Especial vuelve con más integrantes y más casos, y la calma en Crossbell dura poco: nuevas amenazas ponen a prueba a Lloyd y su equipo.",
    ...
    gamepass: false,
    psplus: false,
    critica: "Sale un punto arriba que Trails from Zero y las reseñas explican por qué: cierra todo lo que la anterior dejó abierto, tanto de los personajes como de la trama general, y varias lo ponen entre lo mejor de la saga entera. El combate por turnos también crece respecto del anterior. La condición es la de cualquier segunda parte: hay que haber jugado la primera, porque esto es un final y no un punto de entrada. Los reparos van a la presentación, que sigue siendo la de un juego de hace más de diez años.",
    alta: "2026-07-16",
    noticias: [
      {
        fecha: "2026-09-10",
        titulo: "DEBUTA CON 81, UN PUNTO ARRIBA QUE SU ANTECESOR",
        texto: "Sale el mismo día que Trails from Zero y es su continuación directa: cierra el arco de Crossbell. Las reseñas dicen que paga todo lo que la primera parte dejó sembrado y varias lo ubican entre lo mejor de la saga. Hay que jugar la anterior primero, esto es un final."
      }
    ]
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coakzn.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-16"
  },
  ...
  },
  {
    ...
    gameplay: {
      video: "https://youtube.com/embed/vwez4gW4frA",
      canal: "L0k0hGaming",
      canalUrl: "https://www.youtube.com/@l0k0hgaming"
    },
    metacritic: 76,
    metacriticUsuarios: 6.8,
    metacriticVotos: 4780,
    ...
    noticias: [
      {
        fecha: "2026-09-14",
        titulo: "LLEGA CON 77: MÁS BRUTAL Y MÁS LINEAL QUE SPIDER-MAN",
        texto: "Un día antes del estreno ya hay 117 reseñas, y el promedio quedó en 77. Tres de cada cuatro son positivas y ninguna es negativa: la división está entre quienes lo celebran como una aventura de acción cerrada y sin relleno, y quienes le reclaman que no se anima a más. El combate y la violencia convencen a todos; la repetición y la falta de variedad en la segunda mitad son el reparo que más aparece."
      },
      {
        fecha: "2026-08-14",
  ...
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-10",
        titulo: "SALE EL 15 Y ESE MISMO DÍA ENTRA A PS PLUS Y A GAME PASS",
        texto: "Sony lo confirmó en el catálogo de PlayStation Plus de septiembre y Microsoft ya lo había anunciado para Game Pass el mismo día. O sea que el 15 se puede jugar con cualquiera de las dos suscripciones desde el estreno."
      }
    ]
  },
  {
    ...
    descripcion: "La remake de la segunda parte de Destroy All Humans!. Crypto, el alienígena invasor, vuelve en plenos años sesenta con toda la estética psicodélica de la época, y esta vez va contra la KGB, que le destruyó la nave nodriza.",
  ...
  {
    id: "the-posthumous-investigation",
    titulo: "THE POSTHUMOUS INVESTIGATION",
    relanzamiento: "En PC desde marzo de 2026 — esta fecha corresponde a la edición de Switch",
    duracion: "≈ 13 h (historia) · 14 h (completo)",
    fecha: "2026-09-17",
    plataformas: ["SWITCH"],
    genero: ["AVENTURA", "PUZZLE", "INDIE"],
    desarrollador: "MOTHER GAIA STUDIO",
    descripcion: "Un misterio con bucle temporal en el Río de Janeiro de 1937, basado en la obra de Machado de Assis: hay que resolver el asesinato de Brás Cubas en un solo día que se repite. Se aprenden las rutinas de catorce personajes, se buscan sus contradicciones y se conectan pruebas en un tablero, sin que el juego diga cuál es la respuesta.",
  ...
  },
  {
    id: "fading-echo",
    titulo: "FADING ECHO",
    relanzamiento: "En PC desde julio de 2026 — esta fecha corresponde a la edición de Switch 2",
    duracion: "≈ 6,5 h (historia)",
    fecha: "2026-09-17",
    plataformas: ["SWITCH2"],
    genero: ["ACCION", "AVENTURA", "RPG", "INDIE"],
    desarrollador: "EMETERIA",
    ...
    noticias: [
      {
        fecha: "2026-09-18",
        titulo: "TAMBIÉN SALIÓ EN PS5 Y XBOX",
        texto: "El 22 de septiembre salió también en PS5 y en Xbox Series, cinco días después que en Switch 2."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    gameplay: {
      video: "https://youtube.com/embed/gNn_os8xaok",
      canal: "L0k0hGaming",
      canalUrl: "https://www.youtube.com/@l0k0hgaming"
    },
    metacritic: 89,
    ...
    noticias: [
      {
        fecha: "2026-09-16",
        titulo: "LLEGA CON 89 Y SIN UNA SOLA RESEÑA NEGATIVA",
        texto: "Un día antes del estreno ya tiene 60 reseñas y un promedio de 89. Varias lo ponen entre lo mejor de la saga y lo recomiendan también como puerta de entrada para quien nunca jugó un Fire Emblem."
      },
      {
        fecha: "2026-08-04",
  ...
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-16",
        titulo: "DEBUTA CON 92 Y TODAS LAS RESEÑAS A FAVOR",
        texto: "Sale mañana con 92 de promedio sobre doce reseñas, todas positivas. La crítica lo trata como la versión definitiva del final del arco de Estelle y Joshua, y no le encuentra más que detalles: un arranque lento y gráficos sin lujos."
      }
    ],
    imagen: "https://cdn2.steamgriddb.com/grid/44519406a3f5defa6dcf308d49beef43.png",
    gamepass: false,
    psplus: false,
    alta: "2026-07-16"
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-17",
        titulo: "DEBUT CON 73: EL RPG DE CELULAR SIN GACHA",
        texto: "Sale hoy con 73 sobre catorce reseñas. Todas coinciden en que es la versión definitiva de Another Eden, sin las compras del original para celulares, y le marcan que el arranque es lento."
      }
    ],
    metacriticUsuarios: null,
    imagen: "https://cdn2.steamgriddb.com/grid/f7df4bd051a7facdd6018b29818d5b5c.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-16"
  },
  {
    ...
    titulo: "ZERO PARADES: FOR DEAD SPIES",
    relanzamiento: "En PC desde mayo de 2026 — esta fecha corresponde a la edición de PS5",
    duracion: "≈ 21 h (historia) · 38 h (completo)",
    fecha: "2026-11-03",
    plataformas: ["PS5"],
    genero: ["RPG", "AVENTURA", "INDIE"],
    desarrollador: "ZA/UM",
    descripcion: "El RPG de espionaje de ZA/UM, el estudio que hizo Disco Elysium. El protagonismo es de Hershel Wilk, alias Cascade, que carga desde hace cinco años con una misión en la que perdió a todo su equipo, hasta que llega un encargo misterioso. Todo se resuelve con tiradas de habilidad, por engaño, violencia o deducción, en una ciudad partida entre tres bandos. En PS5 llega como Director's Cut, con la actualización del mismo nombre.",
    trailer: "https://youtube.com/embed/C_acH7Wx1Ew",
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/26ba856ac2a18ce42499c6053aa678e4.png",
    gamepass: false,
    psplus: false,
    alta: "2026-09-17"
  },
  {
    id: "lets-sing-2027",
    titulo: "LET'S SING 2027",
    fecha: "2026-11-03",
    plataformas: ["SWITCH2", "SWITCH"],
    genero: ["MUSICA", "CASUAL", "MULTIJUGADOR"],
    desarrollador: "VOXLER",
    descripcion: "La entrega anual del karaoke de Ravenscourt, con la lista de temas actualizada y los modos de siempre para cantar de a varios. Se juega con micrófonos o con el celular como micrófono, que es lo que lo hace fácil de sacar en una juntada.",
  ...
  {
    id: "lets-sing-abba",
    titulo: "LET'S SING ABBA",
    relanzamiento: "El original salió en octubre de 2022 — esta es la edición de Switch 2",
    fecha: "2026-11-03",
    plataformas: ["SWITCH2"],
    genero: ["MUSICA", "CASUAL", "MULTIJUGADOR"],
    desarrollador: "VOXLER",
    descripcion: "Un Let's Sing dedicado entero a ABBA, con el repertorio del grupo sueco en vez de la lista variada de la entrega anual. Mismo formato: se canta de a varios, con micrófonos o usando el celular.",
  ...
  {
    id: "hope-in-the-city",
    titulo: "HOPE IN THE CITY",
    fecha: "2026-11-10",
    plataformas: ["XBOX"],
    genero: ["AVENTURA", "INDIE"],
    desarrollador: "LOFTY SKY ENTERTAINMENT",
    descripcion: "Un misterio narrativo en la ciudad china de Shenyang. Hope Song, de 17 años, vuelve del colegio y encuentra la casa revuelta y a sus padres desaparecidos, sin una nota. Con su mirada de artista junta pistas y destapa lo que se esconde debajo de la calma de su ciudad, en una investigación que no sigue un camino fijo. Lo hace el equipo de Sky of Tides y Eternal Spring.",
    trailer: "https://youtube.com/embed/aeSj0-tQqxY",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/co9y32.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-17"
  },
  {
    id: "sonic-pico-park",
    titulo: "SONIC PICO PARK",
    fecha: "2026-11-11",
    plataformas: ["PS5", "XBOX"],
    genero: ["PUZZLE", "PLATAFORMA", "COOP", "CASUAL"],
    desarrollador: "TECOPARK",
    descripcion: "PICO PARK, la saga de puzles cooperativos en 2D, se cruza con Sonic. La regla es simple, llegar a la meta, pero ningún nivel se pasa sin coordinarse con los demás. Todos los personajes pueden hacer el giro de Sonic y aparecen mecánicas de sus juegos. Se juega de dos a ocho, en local u online.",
    trailer: "https://youtube.com/embed/RFg-S2seDqU",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocowo.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-17"
  },
  {
    id: "prinny-party-going-overboard",
    titulo: "PRINNY PARTY: GOING OVERBOARD!",
    fecha: "2026-11-11",
    plataformas: ["PS5", "SWITCH"],
    genero: ["CASUAL", "TABLERO", "MULTIJUGADOR"],
    desarrollador: "NIPPON ICHI SOFTWARE",
    descripcion: "Un juego de tablero con los Prinny de Disgaea. Se avanza por el tablero juntando experiencia y equipo para derrotar al Supremo Overboard, pero el mérito se lo lleva sólo quien entrega al jefe, así que la cooperación dura poco: se vale agarrar y tirar a los amigos. Si mueren todos a la vez, pierden todos.",
    trailer: "https://youtube.com/embed/XinU3Iy6lek",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocje8.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-17"
  },
  ...
  {
    id: "marupoyo-the-round-chicks-adventure",
    titulo: "MARUPOYO: THE ROUND CHICK'S ADVENTURE",
    fecha: "2026-11-26",
    plataformas: ["SWITCH2", "SWITCH"],
    genero: ["PLATAFORMA", "ARCADE", "CASUAL", "INDIE"],
    desarrollador: "CASUAL BROTHERS",
    descripcion: "Un plataformas de rodar: Marupoyo es un pollito redondo que se mueve inclinándose, esquivando obstáculos mientras busca a sus hermanos perdidos. Está pensado para que lo agarre cualquiera, con controles de una sola idea bien aprovechada.",
  ...
  {
    id: "kingdom-of-night",
    titulo: "KINGDOM OF NIGHT",
    relanzamiento: "En PC desde diciembre de 2025",
    duracion: "≈ 12 h (historia) · 18 h (completo)",
    fecha: "2026-11-05",
    plataformas: ["XBOX", "SWITCH"],
    genero: ["ACCION", "RPG", "RETRO", "INDIE"],
    desarrollador: "FRIENDS OF SAFETY",
    descripcion: "Un RPG de acción en un pueblo de Arizona en 1987, la noche en que una secta invoca por accidente a Baphomet. John sale a pelear contra la invasión demoníaca y a rescatar a sus amigos, y la aventura avanza hora por hora durante lo que puede ser la última noche del mundo, entre demonios, vecinos poseídos y matones del colegio.",
    trailer: "https://youtube.com/embed/bFVWYd68J5Q",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1094600/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-17"
  },
  {
    id: "edge-of-memories",
    titulo: "EDGE OF MEMORIES",
    fecha: "2026-11-05",
    plataformas: ["PS5", "XBOX"],
    genero: ["RPG", "ACCION"],
    desarrollador: "MIDGAR STUDIO",
    descripcion: "Un RPG de acción de Midgar Studio, los de Edge of Eternity. Una plaga llamada corrosión arrasó un continente y ahora amenaza a los pueblos nómadas de Avaris. Eline, una susurradora de almas, descubre que puede controlar la corrosión dentro de su propio cuerpo, y con Ysoris, su mentor, y Kanta, un príncipe chamán, sale a frenarla.",
    trailer: "https://youtube.com/embed/WsbT4fnsCMU",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2738170/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-17"
  },
  {
    id: "the-legend-of-zelda-ocarina-of-time-switch-2",
  ...
  },
  {
    ...
    titulo: "LORDS OF THE FALLEN II",
    fecha: "2026-12-31",
    estimado: true,
    fechaEstimada: "CUARTO TRIMESTRE 2026",
    plataformas: ["PS5", "SWITCH2"],
    genero: ["ACCION", "RPG", "AVENTURA", "GOTICO"],
    desarrollador: "CI GAMES",
    descripcion: "La segunda parte del RPG de acción de fantasía oscura de CI Games: combate duro al estilo Souls en un mundo que se cae a pedazos desde adentro. Vuelve el juego de los dos planos, el de los vivos y el Umbral de los muertos.",
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc6o3.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-16",
    noticias: [
      {
        fecha: "2026-08-24",
        titulo: "SE RETRASA A MARZO DE 2027",
        texto: "Frozenbyte anunció que el juego pasa del 17 de septiembre al 4 de marzo de 2027. La decisión salió de lo que vieron en la prueba privada: dicen que ahora tienen mucho más claro qué funciona y qué no, y que prefieren usar ese tiempo."
      }
    ]
  },
  {
    ...
    noticias: [
      {
        ...
        texto: "IzanagiGames publicó la demo en PS5, y el 26 de agosto llegan las de Switch 2 y Switch junto con las reservas digitales. Ojo con la fecha: el 26 es de la demo, el juego sale el 17 de septiembre. Se confirmó además que Tsukasa Masuko, de la saga Megami Tensei, trabajó en la banda sonora."
      }
    ]
  },
  {
    id: "shape-of-dreams",
    titulo: "SHAPE OF DREAMS",
    relanzamiento: "En PC desde septiembre de 2025",
    duracion: "≈ 8,4 h (historia) · 57 h (completo)",
    fecha: "2026-09-17",
    plataformas: ["PS5", "XBOX"],
    genero: ["ACCION", "ROGUELIKE", "COOP", "INDIE"],
    desarrollador: "LIZARD SMOOTHIE",
    descripcion: "Un roguelite de acción que mezcla hack and slash con el trabajo en equipo de un MOBA. Se esquivan oleadas de enemigos y se apuntan habilidades a mano por mundos que cambian en cada partida, de campos de lava a montañas nevadas. Cada viajero pelea distinto, y de a cuatro en cooperativo los estilos se combinan. Llega a consolas junto a la actualización Starless Path.",
  ...
  },
  {
    ...
    relanzamiento: "En PS5, Xbox y PC desde mayo de 2026 — esta fecha corresponde a la edición de Switch 2",
    duracion: "≈ 13 h (historia) · 34 h (completo)",
    fecha: "2026-09-18",
    plataformas: ["SWITCH2"],
    genero: ["AVENTURA", "ACCION"],
    desarrollador: "TT GAMES",
    descripcion: "La aventura LEGO de Batman que salió en mayo en PS5, Xbox y PC llega a Switch 2. TT Games recorre las distintas épocas del personaje, de los cómics a las películas y las series, con una Gotham para explorar y un combate que toma mucho de los Batman: Arkham, sin perder el humor ni el cooperativo de la saga.",
    ...
    noticias: [
      {
        fecha: "2026-09-17",
        titulo: "LLEGA A SWITCH 2 CON EL 83 QUE SACÓ EN MAYO",
        texto: "La versión de Switch 2 sale mañana, cuatro meses después que en las otras consolas. En mayo la crítica lo recibió con 83 y varias reseñas lo nombraron el mejor juego LEGO hecho hasta ahora."
      }
    ],
    imagen: "https://cdn2.steamgriddb.com/grid/e154fe98c470195b99092d884dcf71f5.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-16"
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-18",
        titulo: "DEBUT CON 83 EN METACRITIC",
        texto: "Sale hoy con 83 sobre 22 reseñas. La crítica lo recomienda como un juego tranquilo y precioso, que muestra un lado del Valle de los Mumin que los libros casi no cuentan: el invierno."
      }
    ],
  ...
  },
  {
    ...
    descripcion: "Un juego de plataformas con el Grinch, donde se juntan adornos, se usan artefactos y se superan desafíos navideños para armar el mejor árbol de Navidad para los Quién.",
    trailer: "https://youtube.com/embed/a3DI5VfL3TA",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocjdn.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-16"
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-22",
        titulo: "LLEGA A CONSOLAS CON MODO PARA UN JUGADOR",
        texto: "Funcom lo estrena en PS5 y Xbox, donde además entra en Game Pass, con una actualización grande: un modo para un jugador completo con tres niveles de dificultad o reglas a medida (tormentas de arena, recolección, experiencia, durabilidad de objetos), el final del Libro Uno para jugar la historia entera de corrido, recompensas nuevas en las misiones y mejoras en el combate."
      }
    ],
    gamepass: true,
    psplus: false,
  ...
  },
  {
    ...
    descripcion: "Un Silent Hill en primera persona, hecho por Screen Burn. Simon Ordell vuelve a St. Amelia, un pueblo en una isla de Escocia, para arreglar algo de su pasado, y termina metido en un mundo donde hay que esconderse, pelear sólo cuando no queda otra y resolver puzles para ir entendiendo qué pasó ahí.",
    trailer: "https://youtube.com/embed/CvN3dP92wxU",
    gameplay: {
      video: "https://youtube.com/embed/kXnDnGl1t_c",
      canal: "L0k0hGaming",
      canalUrl: "https://www.youtube.com/@l0k0hgaming"
    },
    metacritic: 81,
  ...
  },
  {
    ...
    descripcion: "Un juego de carreras de Hot Wheels repartido en cuatro islas llenas de eventos y desafíos. Se consiguen autos conocidos de la marca, se arma un equipo y se crean pistas propias.",
    trailer: "https://youtube.com/embed/JUZD3j1HY_4",
    metacritic: 73,
    metacriticUsuarios: 6.9,
    metacriticVotos: 17,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc6me.jpg",
    gamepass: false,
    psplus: false,
    critica: "Casi todas las reseñas usan la misma comparación: es Hot Wheels Unleashed cruzado con Forza Horizon, o sea las pistas de juguete metidas en un mundo abierto. Coinciden en que el resultado funciona — cuatro islas distintas entre sí, montones de autos para desbloquear y un manejo arcade que engancha desde el principio. Los reparos son parejos y menores: no hay historia, se pone repetitivo a la larga y varias aclaran que no le saca el puesto a Forza Horizon.",
    alta: "2026-07-16",
    noticias: [
      {
        fecha: "2026-09-10",
        titulo: "DEBUTA CON 75: HOT WHEELS EN MUNDO ABIERTO",
        texto: "Sale hoy y la comparación se repite en todas las reseñas: es Hot Wheels Unleashed cruzado con Forza Horizon. Cuatro islas, muchos autos para desbloquear y manejo arcade. Le marcan que no tiene historia y que se hace repetitivo, pero coinciden en que se disfruta."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    genero: ["RPG", "POR TURNOS", "AVENTURA"],
    desarrollador: "SQUARE ENIX",
    descripcion: "La edición definitiva de Dragon Quest XI: el juego completo más escenarios adicionales, banda sonora orquestal y el modo 2D, que permite recorrer toda la aventura con el estilo de los primeros juegos de la saga.",
  ...
  },
  {
    ...
    desarrollador: "SEGA",
    descripcion: "La vuelta de Shinobi, la saga de ninjas de SEGA, como juego de acción y plataformas en 2D dibujado a mano. Lo hizo Lizardcube, el estudio detrás de Streets of Rage 4: el combate se arma con combos que se van aprendiendo solos, y las habilidades nuevas abren caminos en niveles con algo de metroidvania.",
  ...
  },
  {
    ...
    descripcion: "Un simulador de granja con competencia de por medio. Cada verano, el campamento de Villaperenne elige al mejor granjero del pueblo, y Alessandra se anota buscando un futuro mejor: para ganar tiene que medirse con el resto de los participantes.",
    trailer: "https://youtube.com/embed/wZPxfa9hjDY",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coba9t.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-16"
  },
  {
    ...
    descripcion: "La segunda parte del spin-off de acción de Minecraft: se deja el pico, se agarra la espada y se sale a recorrer mazmorras. La reserva incluye dos aspectos de héroe, una capa y una mascota.",
  ...
  },
  {
    ...
    metacritic: 64,
    metacriticUsuarios: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc6vl.jpg",
    critica: "Un 4X con vuelta ecologista: en vez de conquistar, se limpia y se restaura un planeta. Las cuatro reseñas coinciden en que la idea es buena y que el bucle de dejar todo limpio da satisfacción, con una estética minimalista que acompaña. Y coinciden también en el límite: se repite. Las campañas tienen siempre la misma estructura, las facciones se diferencian poco y no invita a una segunda partida. Es un juego para una vuelta, y las reseñas lo dicen sin dramatizarlo.",
    noticias: [
      {
        fecha: "2026-09-07",
        titulo: "DEBUTA CON 65: BUENA IDEA, POCA VUELTA",
        texto: "Es un 4X donde en lugar de conquistar se restaura un planeta. Las reseñas rescatan la idea y lo satisfactorio del bucle, y coinciden en el reparo: las campañas se repiten y las facciones se diferencian poco, así que no invita a jugarlo dos veces."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/e99c44a4527167035580651d4e5f2f46.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-28"
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-07",
        titulo: "DEBUTA CON 76: LA CANCHA BIEN, LO DE AFUERA NO",
        texto: "El acuerdo entre las nueve reseñas es que la defensa dio un salto y que las animaciones son más dinámicas. Y también que las microtransacciones siguen siendo el problema: varios medios dicen que el básquet es de los mejores en años y que todo lo que pasa fuera de la cancha lo arrastra."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  {
    id: "agefield-high-rock-the-school",
    titulo: "AGEFIELD HIGH: ROCK THE SCHOOL",
    relanzamiento: "En PC desde agosto de 2026",
    duracion: "≈ 19 h (historia)",
    fecha: "2026-09-25",
    plataformas: ["PS5"],
    genero: ["ACCION", "AVENTURA", "INDIE"],
  ...
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-15",
        titulo: "SALE EL 17 EN XBOX Y ENTRA A GAME PASS ESE MISMO DÍA",
        texto: "Xbox confirmó el 17 de septiembre para Xbox Series y PC, con Game Pass desde el primer día. Las versiones de PS5 y Switch 2 todavía no tienen fecha en sus tiendas."
      }
    ],
    gamepass: true,
    psplus: false,
  ...
  },
  {
    ...
    desarrollador: "SQUARE ENIX",
    descripcion: "La remake en 2.5D del RPG de PlayStation que mezcla fantasía y ciencia ficción. Se elige entre Claude y Rena, y la historia se ve desde el punto de vista del elegido.",
  ...
  },
  {
    ...
    descripcion: "Un simulador del puesto de control de una ciudad en decadencia. Se revisa a los sobrevivientes, se racionan recursos y se decide quién entra y quién queda afuera, sabiendo que cada decisión puede costar vidas.",
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cock01.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-21"
  },
  ...
  },
  {
    ...
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/co9m68.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-21",
    noticias: [
      {
        fecha: "2026-08-21",
        titulo: "DEBUTA CON 69, MEJOR EN EL SILLÓN QUE EN LÍNEA",
        texto: "La escondida asimétrica de un fantasma contra cuatro chicos se llevó 69. Las reseñas coinciden en que está pensada para jugar con gente al lado: en línea pierde bastante de su gracia."
      }
    ]
  },
  {
    ...
    descripcion: "Un juego de skate arcade rápido, hecho a la manera de los de 1999: flips, grabs y grinds, combos exagerados y estética noventosa.",
    trailer: "https://youtube.com/embed/pAiVQQizsMA",
    metacritic: 50,
    metacriticUsuarios: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc6vs.jpg",
    critica: "Un 50 que sale de reseñas partidas al medio sobre el mismo diagnóstico. Todas le reconocen que entiende el espíritu de los Tony Hawk de fin de los noventa y que la vuelta al arcade puro se disfruta un rato, con niveles compactos y objetivos claros. Y todas le marcan lo mismo: le falta la precisión que un juego de skate necesita para funcionar, los controles no responden como deberían y hay asperezas por todos lados. Las más benévolas dicen que aun así entretiene; las más duras, que sin esa precisión el homenaje se queda en la intención.",
    gamepass: false,
    psplus: false,
    alta: "2026-07-21",
    noticias: [
      {
        fecha: "2026-09-08",
        titulo: "DEBUTA CON 50: EL HOMENAJE ESTÁ, LA PRECISIÓN NO",
        texto: "El arcade de skate protagonizado por la neerlandesa Sterre Meijer cierra en 50. Las reseñas le reconocen que capta el espíritu de los Tony Hawk de fin de los noventa, pero coinciden en que los controles no tienen la precisión que el género pide, y sin eso los combos no terminan de salir."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    desarrollador: "UBISOFT",
    descripcion: "Una versión rehecha del Rayman Legends de 2013, con gráficos nuevos y la historia contada de otra forma. Suma un reino que no estaba y niveles musicales nuevos, y se sigue pudiendo jugar de a cuatro en la misma consola.",
    trailer: "https://youtube.com/embed/2_7BQ9hLGkk",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc5tb.jpg",
    noticias: [
      {
        fecha: "2026-09-14",
        titulo: "SE RETRASA DOS MESES: SALE EL 3 DE DICIEMBRE",
        texto: "Ubisoft movió la salida del 1 de octubre al 3 de diciembre, en las tres consolas a la vez. La PS Store y Steam ya muestran la fecha nueva, y la reserva sigue abierta."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-20",
        titulo: "HAY DEMO DESDE EL 24 DE SEPTIEMBRE",
        texto: "Koei Tecmo y Omega Force anunciaron una demo que sale el 24 de septiembre, una semana antes del juego."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  {
    id: "agefield-high-rock-the-school-xbox",
    titulo: "AGEFIELD HIGH: ROCK THE SCHOOL",
    relanzamiento: "En PC desde agosto de 2026 y en PS5 desde el 25 de septiembre — esta fecha corresponde a la edición de Xbox",
    duracion: "≈ 19 h (historia)",
    fecha: "2026-10-02",
    plataformas: ["XBOX"],
    genero: ["ACCION", "AVENTURA", "INDIE"],
    desarrollador: "REFUGIUM GAMES",
    descripcion: "La edición de Xbox llega una semana después que la de PS5, con el mismo juego: los últimos tres meses de secundaria de Sam en el Agefield de principios de los 2000, repartidos entre clases obligatorias, travesuras con los amigos y un pueblo para recorrer.",
    trailer: "https://youtube.com/embed/7OU1g4j-ap8",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3562580/library_600x900.jpg",
    gamepass: false,
    ...
    noticias: [
      {
        ...
        texto: "Bandai Namco publicó la cinemática con la que arranca el juego, que sale el 2 de octubre en PS5 y Xbox."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-17",
        titulo: "YA ESTÁ TERMINADO Y SE PUEDE PREINSTALAR DESDE EL 29",
        texto: "The Coalition anunció que el juego pasó a gold, es decir, que la versión de lanzamiento está cerrada. La preinstalación arranca el 29 de septiembre, el acceso anticipado de la edición Premium el 1 de octubre y el lanzamiento para todos el 6, también en Game Pass desde el primer día."
      }
    ],
    gamepass: true,
    psplus: false,
  ...
  },
  {
    ...
    descripcion: "La remasterización de Epic Mickey, el plataformas en 3D donde Mickey usa un pincel mágico para pintar o borrar partes del escenario y transformar el Páramo.",
  ...
  },
  {
    ...
    descripcion: "Un survival horror de acción en primera persona basado en Hellraiser, la saga de terror de Clive Barker, con una historia nueva.",
    ...
    noticias: [
      {
        fecha: "2026-09-23",
        titulo: "CUATRO MINUTOS DE GAMEPLAY, Y HAY DEMO EN PC",
        texto: "Saber Interactive publicó un repaso del gameplay. El combate mezcla armas cuerpo a cuerpo y de fuego con esquivar, buscar munición, poner trampas y negociar mejoras, contra cultistas y otras criaturas. La caja de la Configuración Génesis funciona como poder sobrenatural: lanza objetos, prende fuego a los enemigos y acumula sufrimiento para desatar las cadenas del infierno. En Steam ya hay una demo."
      },
      {
        fecha: "2026-08-19",
  ...
  },
  {
    ...
    titulo: "ECHO WEAVER",
    fecha: "2026-10-08",
    plataformas: ["XBOX", "PS5", "PS4", "SWITCH2"],
    genero: ["ACCION", "AVENTURA", "INDIE"],
    desarrollador: "MOONLIGHT KIDS",
    descripcion: "Un metroidvania de bucle temporal donde no se juntan mejoras sino información: cada vuelta se aprende algo que antes no se sabía y eso es lo que abre camino. Sos el último tejedor y aprovechás las fallas del tiempo para romper el ciclo, así que lo que avanza no es el personaje sino el que está del otro lado del control.",
  ...
  },
  {
    ...
    descripcion: "Un juego de acción y aventura en un país aislado, arrasado por una guerra civil y por una calamidad misteriosa. El protagonista busca los secretos de su propio pasado, y el juego parte de una idea: el peor demonio que hay en esa guerra es la gente.",
  ...
  },
  {
    ...
    descripcion: "Un juego de manejo en mundo abierto ambientado en la isla de O'ahu, en Hawái. Se corren carreras, se participa de eventos temáticos dedicados a distintas culturas del auto y se coleccionan cientos de modelos conocidos.",
  ...
  },
  {
    ...
    descripcion: "Un Katamari que viaja por distintas épocas: se hace rodar la bola por mundos del pasado y del presente, pegándole todo lo que aparezca, para devolver las estrellas al cielo.",
    trailer: "https://youtube.com/embed/JQpojKTAvPY",
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/d4ab910e81e69b831c517056f3731009.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-24"
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coarq4.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-24"
  },
  {
    ...
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/df099083450295b1ead6bc471c031a88.png",
    gamepass: false,
    psplus: false,
    alta: "2026-07-24"
  },
  ...
  },
  {
    ...
    genero: ["SIMULACION", "ESTRATEGIA"],
    desarrollador: "FRONTIER DEVELOPMENTS",
    descripcion: "La secuela del simulador de zoológicos. Se construyen parques por todo el mundo con animales terrestres, aves y especies acuáticas, y ahora también se los puede liberar en reservas naturales abiertas.",
  ...
  },
  {
    ...
    genero: ["ACCION", "AVENTURA"],
    desarrollador: "PURPLE LAMP",
    descripcion: "Un plataformas de Bob Esponja con tono de terror. Una pelea entre el Holandés Errante y el Rey Neptuno llenó Fondo de Bikini de caos, y hay que alternar entre Bob Esponja y Patricio, combinando sus habilidades, para que no quede convertida en un pueblo fantasma.",
    trailer: "https://youtube.com/embed/wcDpp_9G6V0",
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/30ad15654dfe614c9ec13b65d0947cba.png",
    gamepass: false,
    psplus: false,
    alta: "2026-07-24"
  },
  {
    ...
    genero: ["ACCION", "RPG"],
    desarrollador: "KONAMI",
    descripcion: "Un Castlevania nuevo de acción y exploración en 2D, hecho por Konami junto a Evil Empire y Motion Twin, los de Dead Cells. La historia pasa 23 años después de Castlevania III: Dracula's Curse y la protagonista es Rose Belmont.",
    trailer: "https://youtube.com/embed/ZRgOG0Phue8",
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/36368348f3b5677aacd95ca9c51a0c4b.png",
    noticias: [
      {
        fecha: "2026-09-20",
        titulo: "HAY DEMO DESDE EL 1 DE OCTUBRE",
        texto: "Konami, Evil Empire y Motion Twin anunciaron una demo para el 1 de octubre, dos semanas antes del lanzamiento."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    descripcion: "Un RPG de acción y supervivencia cooperativo para hasta dieciséis jugadores. Se es un Flameborn, la última esperanza de una raza que se muere, en un reino tapado por una niebla corrupta: se pelea contra enemigos, se construyen edificaciones y se va recuperando el mundo.",
  ...
  },
  {
    ...
    plataformas: ["SWITCH", "PS4", "XBOX", "PS5"],
    genero: ["ACCION", "AVENTURA"],
    desarrollador: "DIGITAL ECLIPSE",
    descripcion: "La vuelta del juego de Toy Story 3, la aventura en 3D basada en la película de 2010. Tiene un modo historia con momentos de la película y el modo caja de juguetes, un mundo libre en el Oeste del Rodeo de Woody.",
    trailer: "https://youtube.com/embed/Kgp9iOHxrFw",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc5v1.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-24"
  },
  {
    id: "toy-story-retro-roundup",
    titulo: "DISNEY/PIXAR TOY STORY: RETRO ROUNDUP",
    relanzamiento: "Recopilación de seis juegos publicados entre 1995 y 2001",
    fecha: "2026-10-15",
    plataformas: ["PS5", "PS4", "SWITCH2", "SWITCH", "XBOX"],
    genero: ["PLATAFORMA", "AVENTURA", "ARCADE", "RETRO"],
    desarrollador: "ATARI",
    descripcion: "Vuelta al cuarto de Andy con Woody, Buzz y compañía. La colección junta seis juegos de los noventa y principios de los dos mil —Toy Story, las dos versiones de Toy Story 2, Buzz Lightyear del Comando Estelar, Toy Story Racer y Bichos— con sus versiones de consola y de portátil, once en total, todas retocadas y con material de archivo sobre cómo se hicieron.",
    trailer: "https://youtube.com/embed/Kgp9iOHxrFw",
    metacritic: null,
  ...
  },
  {
    ...
    plataformas: ["PS4", "XBOX", "PS5", "SWITCH", "SWITCH2"],
    genero: ["ACCION", "RPG"],
    desarrollador: "TOSE CO., LTD.",
    descripcion: "La remasterización de Tales of Eternia, el RPG de Bandai Namco. Una catástrofe amenaza con destruir el universo y el viaje decide el destino de dos mundos, Inferia y Celestia.",
    trailer: "https://youtube.com/embed/n0Trr5yLK1A",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc7n7.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-24"
  },
  ...
  },
  {
    ...
    fecha: "2026-10-22",
    plataformas: ["SWITCH2", "PS5", "SWITCH", "XBOX"],
    genero: ["RPG"],
    desarrollador: "SQUARE ENIX",
    descripcion: "Un Final Fantasy nuevo con pixel art que parte del estilo de los clásicos y lo lleva más lejos. El grupo avanza guiado por visiones que ayudan en el combate y revelan la verdad detrás de una fuerza que amenaza con destruirlo todo.",
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/74c2332a45194579034d079bd325b62a.png",
    gamepass: false,
    psplus: false,
    alta: "2026-07-24"
  },
  ...
  },
  {
    ...
    descripcion: "Un simulador de gestión en el mundo de One Piece: con los Sombrero de Paja se arma el mejor restaurante flotante de los mares. Se juntan ingredientes, se diseñan platos y se decora el local para que los clientes vuelvan.",
    trailer: "https://youtube.com/embed/gaQqFfKj-SA",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc7mu.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-24"
  },
  {
    ...
    descripcion: "Un juego de acción de S-Game hecho en Unreal Engine 5, que mezcla la narrativa de las historias wuxia con combates muy rápidos. Se juega como Soul, un guerrero al que le quedan 66 días de vida y que se cruza con asesinos y conspiraciones.",
    trailer: "https://youtube.com/embed/EZr1HXkEahs",
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/c2ca23c951caaa036189141224933bb8.png",
    noticias: [
      {
        fecha: "2026-08-18",
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc3jf.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-24"
  },
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/bbb0d4ea00daa067858994928a845290.png",
    noticias: [
      {
        fecha: "2026-07-29",
  ...
  },
  {
    ...
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coasxc.jpg",
    noticias: [
      {
        fecha: "2026-08-17",
        titulo: "59 DE DEBUT PARA EL FÚTBOL AUSTRALIANO ABSURDO",
        texto: "Debuta con 59. Es un juego de fútbol australiano hecho por Powerbomb Games y Tinker Town, de Adelaida, que apuesta todo al absurdo: más de 150 mejoras que van deformando las reglas. Las notas lo dejan en terreno flojo, que es lo habitual cuando la gracia de un juego es el desorden y no la solidez de sus sistemas."
      },
      {
        fecha: "2026-08-12",
  ...
  },
  {
    ...
    descripcion: "Un survivors-like de zombis en el que no se maneja un personaje sino un escuadrón de tres, cada uno con su clase y su rama de mejoras. Las oleadas no paran y todo se juega en elegir bien qué potenciar entre nivel y nivel, buscando la combinación que aguante un minuto más. Se puede jugar de a varios.",
    trailer: "https://youtube.com/embed/foG7tODmFks",
    metacritic: 79,
    metacriticUsuarios: null,
    critica: "Las reseñas arrancan todas por el mismo lado: es otro survivors-like y no pretende ser otra cosa. Lo que rescatan es la cantidad de contenido, los personajes que se van desbloqueando y un sistema de mejoras permanentes que engancha, pero sobre todo el escuadrón de tres, que abre sinergias entre clases que el resto del género no tiene. El reparo también se repite: el escenario es convencional, la progresión se vuelve previsible y en pocas horas ya viste casi todo. En cooperativo aguanta bastante más.",
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2163330/library_600x900.jpg",
    noticias: [
      {
        fecha: "2026-09-11",
        titulo: "DEBUT CON 79 EN METACRITIC",
        texto: "Entró al medidor con 79, aunque sobre pocas reseñas: en PS5 lo cubrieron apenas un puñado de medios. Las cuatro que están publicadas coinciden en que el escuadrón de tres es lo que lo separa del montón de survivors-likes, y en que se queda sin sorpresas antes de lo que uno querría."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-03",
        titulo: "DEBUTA CON 66: BUEN SISTEMA DE CLASES, MUCHOS ERRORES",
        texto: "Las reseñas se dividen. Coinciden en el sistema de clases y en que suma un cuarto puesto al escuadrón, pero también en los errores técnicos, que en un cooperativo duelen más porque sacan a los jugadores de la partida. Varias señalan que se parece demasiado al primero, de hace cinco años."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    descripcion: "Un juego de puzles tranquilo donde hay que sentar a un montón de personajes con forma geométrica, cada uno con sus manías. El desafío es encontrarle a cada uno el lugar justo.",
    ...
    noticias: [
      {
        fecha: "2026-08-31",
        titulo: "LLEGA A PS5 CON 79 EN METACRITIC",
        texto: "El puzle de Poti Poti Studio salió en PC en agosto de 2025 y llega ahora a PS5 con el puntaje ya hecho: 79 sobre quince reseñas. La prensa coincide en que la gracia está en lo simple —sentar gente respetando lo que cada uno pide— y avisa que son unas cinco horas, mejor repartidas en varias sesiones que de un tirón."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    fecha: "2027-03-11",
    plataformas: ["PS5", "XBOX"],
    genero: ["SIMULACION", "CARRERAS"],
    desarrollador: "SABER INTERACTIVE",
    descripcion: "Un simulador de camiones de 40 toneladas por la costa sur de Estados Unidos, de Jacksonville a Savannah. Se toman encargos, se eligen remolques y rutas, y se lidia con el clima y caminos peligrosos para pasar de novato a transportista con empresa propia. El peso, el desgaste y los frenos cuentan.",
    trailer: "https://youtube.com/embed/PoYMFv8V1ag",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coaaxo.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-17"
  },
  {
    ...
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/9cd0f2a7c17876d6721916f09bce496c.png",
    noticias: [
      {
        fecha: "2026-09-15",
        titulo: "LA VERSIÓN DE SWITCH 2 SE RETRASA A MARZO DE 2027",
        texto: "IO Interactive corrió la edición de Switch 2 a marzo de 2027, sin día confirmado. La eShop ya le sacó la fecha y lo muestra como próximamente."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    fecha: "2026-09-16",
    relanzamiento: "En PC y Xbox en acceso anticipado desde 2022, y en PC terminado desde 2025 — esta fecha corresponde a la edición de Switch",
    ...
    noticias: [
      {
        fecha: "2026-08-20",
        titulo: "YA TIENE DÍA: 16 DE SEPTIEMBRE EN SWITCH",
        texto: "SUNNY SIDE UP confirmó fecha y precio para la versión de Switch: 16 de septiembre a 19,99 dólares, con todo el contenido y las mejoras de la versión de PC terminada. De paso anunciaron que el juego pasó el medio millón de copias vendidas."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    descripcion: "Un juego de rol, terror y simulación de vida. Fiona deja un trabajo sin futuro para empezar de nuevo en una granja y termina convertida en emisaria inmortal de un dios muerto: hay que hacer amigos, pelear contra horrores y pagar deudas.",
  ...
  },
  {
    ...
    descripcion: "El juego oficial del campeonato de motocross de 2026, con todos sus circuitos y pilotos. Apuesta por la simulación: se siente cada salto, cada bache y cada impacto.",
  ...
  {
    id: "rangers-path-national-park-simulator",
    titulo: "RANGER'S PATH: NATIONAL PARK SIMULATOR",
    relanzamiento: "En PC, en acceso anticipado, desde marzo de 2026",
    fecha: "2026-11-17",
    plataformas: ["PS5", "XBOX"],
    genero: ["SIMULACION", "AVENTURA"],
    desarrollador: "TO-GO GAMES",
    descripcion: "Un simulador de guardaparques en el Parque Nacional Faremont. Se mantienen senderos, se controlan permisos, se ayuda a los visitantes y se atienden emergencias, desde excursionistas perdidos hasta avisos por animales salvajes, en bosques, praderas y ríos que se recorren con los vehículos del parque.",
    trailer: "https://youtube.com/embed/psdgBxit-Ak",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coafye.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-17"
  },
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/64b2cff442cb6bc7403d5bf5722f8273.png",
    gamepass: false,
    psplus: false,
    alta: "2026-07-30",
    noticias: [
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc7oa.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-30"
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocb9n.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-30"
  },
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc7ms.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-30"
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc7pv.jpg",
    noticias: [
      {
        fecha: "2026-09-24",
        titulo: "MÁS DETALLES: SCOUT RUN, COMBATES EN CONJUNTO Y MONSTRUOS NUEVOS",
        texto: "Square Enix y TOSE mostraron el reclutamiento rápido de monstruos (Quick Scouting y Scout Run), los combates en conjunto, el personaje de Almira y un grupo de monstruos nuevos."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc9g1.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-30"
  },
  ...
  },
  {
    ...
    descripcion: "La remasterización del juego de peleas de monstruos gigantes de Godzilla. Se elige un monstruo y se destroza la ciudad a golpes, contra amigos en local o en el multijugador online nuevo.",
    trailer: "https://youtube.com/embed/8N9QN4X1pIk",
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/49a971f590a2340c314be8d59a676c7f.png",
    gamepass: false,
    psplus: false,
    alta: "2026-07-28"
  },
  {
    ...
    fecha: "2026-11-06",
    plataformas: ["XBOX", "PS5", "SWITCH2", "SWITCH"],
    genero: ["TABLERO", "CASUAL", "MULTIJUGADOR"],
    desarrollador: "CASUAL BROTHERS",
    descripcion: "Tres juegos de mesa clásicos de Hasbro pensados para jugar en familia con los más chicos.",
    trailer: "https://youtube.com/embed/OhYII4UeVzY",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocm0w.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-28"
  },
  {
    ...
    fecha: "2026-11-12",
    plataformas: ["XBOX", "PS4", "PS5"],
    genero: ["CASUAL", "AVENTURA", "RETRO"],
    desarrollador: "DIGITAL ECLIPSE",
    descripcion: "Un juego tranquilo de decorar la DreamHouse de Barbie con objetos de distintas épocas de la muñeca. Además trae una colección de videojuegos viejos de Barbie para volver a jugar.",
    trailer: "https://youtube.com/embed/zBymaS2mCaI",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc771.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-28"
  },
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/co66va.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-31",
    noticias: [
      {
        fecha: "2026-09-09",
        titulo: "YA TIENE DÍA: 10 DE DICIEMBRE",
        texto: "Nintendo lo confirmó en el Direct. Venía anunciado para fin de 2026 sin día, y ahora la eShop lo lista para el 10 de diciembre. Es el regreso de Layton después de más de una década."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/co9xhc.jpg",
    noticias: [
      {
        fecha: "2026-09-21",
        titulo: "SE RETRASA A 2027",
        texto: "DrinkBox Studios lo pasó a 2027. Estaba previsto para fines de 2026 y todavía no tiene día; la página de Steam ya dice 2027."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coawh1.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-31"
  },
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/7703de3826577efd144f0367e82f3103.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-31"
  },
  {
    ...
    fecha: "2027-06-30",
    estimado: true,
    fechaEstimada: "SEGUNDO TRIMESTRE 2027",
    plataformas: ["PS5"],
    genero: ["ACCION", "AVENTURA", "RPG"],
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coajy0.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-31",
    noticias: [
      {
        fecha: "2026-09-09",
        titulo: "SE RETRASA MEDIO AÑO: PASA A 2027",
        texto: "Shueisha Games y DeskWorks lo movieron de fin de 2026 a principios del verano de 2027, que en el hemisferio norte es alrededor de junio. Todavía no hay día confirmado y la PlayStation Store lo sigue listando como anunciado, sin fecha."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/cb07accc409bbb4c0adc6afb26cf351b.png",
    gamepass: false,
    psplus: false,
    alta: "2026-07-31"
  },
  {
    id: "9-rip-sequel",
    titulo: "9 R.I.P. SEQUEL",
    fecha: "2026-10-27",
    plataformas: ["SWITCH"],
    genero: ["NOVELA VISUAL", "ANIME"],
    desarrollador: "IDEA FACTORY",
    descripcion: "La continuación de 9 R.I.P., la novela visual de Idea Factory, que retoma la historia y los personajes del primer juego.",
    trailer: "https://youtube.com/embed/HpjxMnOqI4U",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coab2m.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-17"
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cobtql.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-07-31"
  },
  ...
  },
  {
    ...
    descripcion: "El regreso de los juegos de instrumentos de plástico, hecho por RedOctane, el estudio que creó Guitar Hero. Se toca guitarra, bajo, batería o voz sobre la autopista de notas de siempre, con más de noventa canciones con licencia y la posibilidad de armar banda de a varios, en la misma consola o por internet. La novedad es un modo gira con estructura roguelite, donde cada recorrido cambia, y un modo arcade para jugar con el joystick común, sin instrumento.",
    trailer: "https://youtube.com/embed/xU-qK6FyUoM",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocriy.jpg",
    noticias: [
      {
        fecha: "2026-08-25",
        titulo: "SALE EL 10 DE DICIEMBRE, CON METALLICA Y LOS ROLLING STONES EN LA LISTA",
        texto: "RedOctane puso fecha en la gamescom: el 10 de diciembre en PS5 y Xbox. La lista arranca con más de noventa canciones de seis décadas, entre ellas temas de Metallica, The Rolling Stones, Red Hot Chili Peppers, Olivia Rodrigo, blink-182, Paramore, Slipknot y Muse, y el estudio avisó que va a seguir anunciando más antes del estreno. También hay más de 180 guitarras reales de Gibson, Epiphone y Kramer para coleccionar dentro del juego, y una línea propia de instrumentos que ya se puede reservar en la web oficial."
      },
      {
        fecha: "2026-08-25",
        titulo: "UN MODO GIRA ROGUELITE, KARAOKE Y SE PUEDE JUGAR SIN INSTRUMENTO",
        texto: "La novedad es el modo gira: una campaña roguelite donde cada recorrido trae decisiones y desafíos distintos para la banda. Aparte están la partida rápida, la práctica y el karaoke. Se juega con guitarra, bajo, batería o micrófono en cuatro dificultades, más un nivel Experto Plus exclusivo de la batería, y el modo arcade permite usar el joystick con cuatro o cinco carriles. El multijugador es cooperativo, local u online, con juego cruzado entre plataformas y cualquier combinación de instrumentos."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-08-24",
        titulo: "DEBUTA CON 77 Y LAS RESEÑAS SE PARTEN AL MEDIO",
        texto: "El cooperativo de zombis de hasta ocho jugadores se llevó 77. Lo llamativo es que las reseñas coinciden en todo salvo en la conclusión: mismos elogios a los mapas y a la tensión de la muerte definitiva, mismas quejas por los errores y el rendimiento, y veredictos opuestos. Con joystick, además, varias dicen que se juega peor que con mouse."
      },
      {
        fecha: "2026-08-11",
  ...
  },
  {
    ...
    metacritic: 71,
    metacriticUsuarios: null,
    critica: "Cinco reseñas, cuatro benévolas y una demoledora. El acuerdo está en el combate y en el arte, que gustan, y en el precio, que varias mencionan como parte del argumento a favor. Los reparos también coinciden: la parte roguelike quedó a medio hacer. Lo que parte a la prensa es el humor, que para la mayoría es parte del encanto y para la reseña más dura es grosería sin gracia apoyada en estereotipos.",
    imagen: "https://cdn2.steamgriddb.com/grid/dc9b85240a54ffb59e7569225527c92c.png",
    noticias: [
      {
        fecha: "2026-08-20",
        titulo: "SALE CON 69, Y EL HUMOR ES LO QUE PARTE A LA PRENSA",
        texto: "Cinco reseñas: cuatro benévolas y una demoledora. El acuerdo está en el combate, en el arte y en el precio, que varias mencionan como parte del argumento a favor. El reparo compartido es que la parte roguelike quedó a medio hacer. Lo que divide es el humor: para la mayoría es parte del encanto y para la reseña más dura es grosería sin gracia apoyada en estereotipos."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-08-21",
        titulo: "DEBUTA CON 83 Y LAS RESEÑAS SON PAREJAS",
        texto: "La novela visual romántica que reescribe el Mago de Oz en clave oscura debutó con 83, con notas muy juntas entre 80 y 87. Se elogia que se juegue a interpretar a la protagonista en vez de adivinar qué quiere escuchar cada pretendiente."
      }
    ]
  },
  {
    ...
    metacriticUsuarios: 8.0,
    metacriticVotos: 4,
    critica: "Todas las reseñas lo ubican en el mismo lugar: es un juego a lo Vampire Survivors, pero de plataformas en dos dimensiones, y ese cambio de formato es lo que le da identidad propia. Los elogios van al ritmo, al dibujo bruto y gracioso, y a lo bien que se siente moverse. Los reparos coinciden en la falta de profundidad: hay muchos juguetes para probar pero pocos niveles, y la nota más baja dice que el estudio aplicó su talento a un género ya agotado con un resultado más conservador de lo esperado.",
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc6nb.jpg",
    gamepass: true,
    psplus: false,
    alta: "2026-07-31",
    noticias: [
      {
        fecha: "2026-08-26",
        titulo: "DEBUTA CON 77 Y ENTRÓ A GAME PASS EL DÍA UNO",
        texto: "Lo nuevo de los creadores de Nidhogg se llevó 77. Las reseñas coinciden en que la gracia es el cambio de formato: un Vampire Survivors hecho plataformas en dos dimensiones. Salió ayer y entró a Game Pass el mismo día."
      },
      {
        fecha: "2026-08-19",
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cobz5q.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-08-10"
  },
  {
    id: "menherarium",
    titulo: "MENHERARIUM: DEADLY DICE",
    relanzamiento: "En PC desde febrero de 2026",
    fecha: "2026-08-13",
    plataformas: ["SWITCH"],
    genero: ["CARTAS", "ROGUELIKE", "INDIE"],
    desarrollador: "テスカトリポカ",
    descripcion: "Un roguelite de construcción de mazos donde hay que sobrevivir siete días jugando al chinchirorin, un juego de dados japonés, apostando sangre contra una chica que no quiere que te vayas nunca.",
    trailer: "https://youtube.com/embed/wWh06nl7vUo",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3394770/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-08-10"
  },
  {
    ...
    titulo: "SERIOUS SAM: SHATTERVERSE",
    fecha: "2026-08-31",
    plataformas: ["PS5", "XBOX"],
    genero: ["FPS", "ACCION", "COOP", "ROGUELIKE"],
    ...
    noticias: [
      {
        fecha: "2026-09-14",
        titulo: "DEBUT CON 48 EN METACRITIC",
        texto: "Entró al medidor con 48, sobre apenas un puñado de reseñas, y es de los puntajes más bajos del mes. La crítica le reclama que las mejoras no pesan, que solo está desbalanceado y que el emparejamiento online falla. Lo que rescatan es que, con amigos y cuando la partida agarra ritmo, se deja jugar."
      }
    ],
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cobw5w.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-08-10"
  },
  {
    ...
    titulo: "MOONLIGHTER 2: THE ENDLESS VAULT",
    fecha: "2026-09-02",
    plataformas: ["PS5", "XBOX", "SWITCH2"],
    genero: ["ACCION", "RPG", "AVENTURA", "INDIE"],
    desarrollador: "DIGITAL SUN",
    descripcion: "La secuela de Moonlighter, donde se es comerciante y héroe a la vez. Se entra a dimensiones llenas de tesoros y enemigos, se vende lo que se trae en la tienda propia y se reinvierte en equipo para la próxima expedición.",
  ...
  },
  {
    id: "aerea",
    titulo: "AEREA",
    relanzamiento: "Original de 2017 en PS4, Xbox One y PC",
    duracion: "≈ 12 h (historia) · 23 h (completo)",
    fecha: "2026-09-03",
    plataformas: ["XBOX", "PS5", "SWITCH"],
    genero: ["ACCION", "RPG", "MUSICA", "INDIE"],
    desarrollador: "SOEDESCO",
    descripcion: "Un RPG de acción donde la música es arma y problema a la vez. Como discípulo del Gran Maestro Guido, hay que recuperar los nueve instrumentos esenciales para devolverle el equilibrio al mundo de Aezir.",
    trailer: "https://youtube.com/embed/nE3MzsmUNY0",
    metacritic: 46,
    metacriticUsuarios: 4.5,
    metacriticVotos: 16,
    ...
    noticias: [
      {
        fecha: "2026-09-03",
        titulo: "VUELVE UN JUEGO DE 2017 QUE NO FUE BIEN RECIBIDO: 46",
        texto: "Llega hoy a Xbox, PS5 y Switch el dungeon crawler de instrumentos musicales que salió en 2017. El puntaje es el de entonces. Las reseñas rescatan la banda sonora y el mundo, y coinciden en lo demás: simple, repetitivo y con muchos errores."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  {
    id: "isle-of-reveries",
    titulo: "ISLE OF REVERIES",
    fecha: "2026-09-04",
    plataformas: ["XBOX", "PS5", "PS4"],
    genero: ["ACCION", "AVENTURA", "RPG", "INDIE"],
    desarrollador: "DESERTCUCCO",
    descripcion: "Una peregrinación por el cielo hasta la Isla de los Ensueños, donde cualquier deseo se cumple. Mazmorras misteriosas, puzles y un mundo abierto para explorar.",
    trailer: "https://youtube.com/embed/BqzYGeTBfjg",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3100970/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-08-10"
  },
  {
    id: "endless-legend-2",
    titulo: "ENDLESS LEGEND 2",
    fecha: "2026-09-17",
    plataformas: ["PS5", "XBOX"],
    genero: ["ESTRATEGIA", "POR TURNOS", "RPG"],
  ...
  },
  {
    ...
    trailer: "https://youtube.com/embed/9RmMhWiXdV8",
    metacritic: 77,
    metacriticUsuarios: 8.2,
    metacriticVotos: 11,
    critica: "Pocas reseñas, y todas en la misma línea: un plataformas raro a propósito, pensado para quien extraña los juegos de Nintendo 64. Le celebran la personalidad y un mundo bizarro distinto a cualquier otro, donde se corre y se arma lío sin que nadie diga qué hacer. Ese es también el reparo: casi no da indicaciones, y jugado como un plataformas común confunde.",
    metacriticUsuarios: 8.4,
    metacriticVotos: 11,
  ...
  {
    id: "the-walking-dead-streets-of-survival",
    titulo: "THE WALKING DEAD: STREETS OF SURVIVAL",
    fecha: "2026-09-18",
    plataformas: ["SWITCH2", "PS5", "XBOX", "SWITCH"],
    genero: ["LUCHA", "ARCADE", "ACCION"],
    desarrollador: "ODACLICK GAME STUDIO",
  ...
  {
    id: "way-of-the-hunter-2",
    titulo: "WAY OF THE HUNTER 2",
    fecha: "2026-09-29",
    plataformas: ["XBOX", "PS5"],
    genero: ["SIMULACION", "AVENTURA", "MUNDO ABIERTO"],
    desarrollador: "NINE ROCKS GAMES",
    descripcion: "Un simulador de caza en Norteamérica y la sabana africana. Se rastrean especies de caza mayor, como alces y búfalos cafre, y también de caza menor y aves, y las piezas se exhiben como trofeo.",
    trailer: "https://youtube.com/embed/pXmR2QV_Cyc",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cobdqj.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-08-10"
  },
  {
    ...
    titulo: "STUPID NEVER DIES",
    fecha: "2026-10-21",
    plataformas: ["PS5"],
    genero: ["ACCION", "RPG", "AVENTURA"],
    desarrollador: "GPTRACK50 INC.",
    descripcion: "Convierte al torpe zombi Davy en una bestia imparable en este RPG de acción de evolución frenética. Devora enemigos, roba sus poderes y salva a la congelada Julia.",
    trailer: "https://youtube.com/embed/vPqRLWnV4jk",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc8br.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-08-10"
  },
  {
    id: "diablo-4",
    titulo: "DIABLO IV: AGE OF HATRED COLLECTION",
    relanzamiento: "En PS5, Xbox y PC desde 2023",
    duracion: "≈ 26 h (historia) · 195 h (completo)",
    fecha: "2026-09-15",
    plataformas: ["SWITCH2"],
    genero: ["ACCION", "AVENTURA", "CASUAL", "MULTIJUGADOR"],
    desarrollador: "BLIZZARD ENTERTAINMENT, INC.",
    descripcion: "El Diablo de 2023 llega a Switch 2 en una colección, con la campaña por Santuario. Es rol y acción de ver el mapa desde arriba, juntar botín y volver a entrar, y se puede jugar en cooperativo por internet.",
    trailer: "https://youtube.com/embed/7RdDpqCmjb4",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2344520/library_600x900.jpg",
    noticias: [
      {
        fecha: "2026-09-12",
        titulo: "YA TIENE DÍA: SALE EL 15 DE SEPTIEMBRE",
        texto: "Blizzard confirmó que la versión de Switch 2 se llama Age of Hatred Collection y sale el 15 de septiembre. La eShop ya la tiene con esa fecha."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    noticias: [
      {
        fecha: "2026-09-16",
        titulo: "SALE HOY GRATIS Y DEBUTA CON 78",
        texto: "Llega gratis a PS5, Xbox y Switch 2 con un 78 sobre seis reseñas. La crítica lo recomienda para coleccionar criaturas y explorar sin apuro, y le marca poca tensión y una interfaz incómoda."
      },
      {
        fecha: "2026-08-14",
  ...
  },
  {
    ...
    descripcion: "Un beat 'em up rápido con He-Man, Man-At-Arms y Teela, que mezcla la contundencia de los arcade clásicos con la fantasía de la serie animada.",
  ...
  },
  {
    ...
    descripcion: "Un simulador de carreras de resistencia que no se queda en el volante: además de manejar, se hace de ingeniero de carrera y se toman las decisiones desde boxes.",
  ...
  },
  {
    ...
    genero: ["ACCION", "AVENTURA", "CASUAL"],
    desarrollador: "ART OF PLAY INTERACTIVE",
    descripcion: "Play as Danger Mouse or Penfold through 15 side scrolling, arcade battle action, super danger filled levels - all to stop the latest evil plan by Baron Greenback!",
  ...
  },
  {
    ...
    descripcion: "Un roguelite de acción contra el archidemonio Asmodeo, con balas por todos lados y jefes al estilo Souls. En cada intento aparecen bendiciones que cambian los poderes del cazador inmortal que se controla.",
  ...
  },
  {
    ...
    descripcion: "Una aventura para un jugador protagonizada por Ari, un estudiante que viaja por la historia gracias a un profesor bastante particular, detrás de un tesoro perdido en el tiempo.",
  ...
  },
  {
    ...
    descripcion: "Un RPG sobre camioneros, donde se es el conductor y no el camión. Se transportan cargas, se reconstruye una ciudad olvidada y se hace crecer la empresa, y entre viaje y viaje se baja a la calle a relacionarse con la gente. El camión se personaliza por completo.",
  ...
  },
  {
    ...
    descripcion: "Un juego de golf en línea para hasta ocho personas a la vez. Apunta, golpea la pelota, desbarajusta las rondas de los demás y queda en primera posición en esta carrera caótica hacia el hoyo final.",
  ...
  {
    id: "case-solved-the-london-files",
    titulo: "CASE SOLVED: THE LONDON FILES",
    fecha: "2026-07-29",
    plataformas: ["XBOX", "PS5", "SWITCH"],
    genero: ["CASUAL", "INDIE", "SIMULACION"],
    desarrollador: "MINIMOL GAMES",
    descripcion: "Un juego de lógica ambientado en un Londres noir. Hay asesinatos, testimonios que se contradicen y coartadas que no cierran, y cada caso se resuelve razonando, sin adivinar.",
    trailer: "https://youtube.com/embed/97fqlfI8S3U",
    metacritic: 62,
    critica: "El puntaje esconde una discusión. Cinco reseñas lo tratan con cariño —un puzle detectivesco liviano, de un par de horas, con buena ambientación noir y casos entretenidos— y son claras en que hay que ir con esas expectativas: no es una aventura de investigación profunda y no se rejuega. Pero hay una que lo destroza con 20, y no por el diseño sino porque no le funcionó: lo describe como roto. Vale saberlo antes de comprarlo.",
    metacriticUsuarios: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coclvy.jpg",
    noticias: [
      {
        fecha: "2026-09-01",
        titulo: "62 EN METACRITIC, CON UNA RESEÑA QUE LO DESTROZA",
        texto: "Cinco reseñas lo tratan con cariño como lo que es —un puzle detectivesco liviano de un par de horas, con buena ambientación noir— y una lo baja a 20, no por el diseño sino porque no le funcionó: lo describe como roto. El promedio queda en 62 y esconde esa discusión."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    descripcion: "Una aventura gráfica point and click en Verice Bay, protagonizada por Margaret, una artista, y Hector, un inventor. Un invento suyo los lleva a los límites del espacio y del tiempo para evitar un desastre.",
  ...
  },
  {
    ...
    genero: ["ACCION"],
    desarrollador: "CITY CONNECTION",
    descripcion: "Hardcore yet cute Danmaku shooting makes a grand comeback!",
  ...
  },
  {
    ...
    duracion: "≈ 30 h (historia) · 60 h (completo)",
  ...
  },
  {
    ...
    duracion: "≈ 12 h (historia) · 29 h (completo)",
    fecha: "2026-08-18",
    plataformas: ["PS5", "XBOX", "SWITCH2", "SWITCH"],
    genero: ["ACCION", "RPG", "COOP"],
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coco7i.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-08-14"
  },
  {
    ...
    titulo: "MIND DIVER",
    relanzamiento: "En PC desde septiembre de 2025",
    duracion: "≈ 3,9 h (historia) · 4,4 h (completo)",
    fecha: "2026-08-27",
    plataformas: ["PS5", "SWITCH2"],
    genero: ["AVENTURA", "INDIE", "PUZZLE"],
  ...
  },
  {
    ...
    titulo: "ANGELINE ERA",
    relanzamiento: "En PC desde diciembre de 2025",
    duracion: "≈ 14 h (historia) · 18 h (completo)",
    fecha: "2026-09-02",
  ...
  },
  {
    ...
    relanzamiento: "En PC desde 2024",
    duracion: "≈ 5,4 h (historia) · 11 h (completo)",
    fecha: "2026-08-27",
    plataformas: ["PS5", "XBOX"],
    ...
    trailer: "https://youtube.com/embed/5BAs28YwULY",
    metacritic: null,
  ...
  },
  {
    ...
    relanzamiento: "En PC desde 2024",
    duracion: "≈ 30 h (historia) · 89 h (completo)",
    fecha: "2026-09-15",
    plataformas: ["PS5", "XBOX", "SWITCH2", "SWITCH"],
    genero: ["SIMULACION", "CASUAL", "INDIE"],
  ...
  },
  {
    ...
    fecha: "2026-08-20",
    plataformas: ["SWITCH2"],
    genero: ["AVENTURA", "CASUAL", "MUNDO ABIERTO"],
    desarrollador: "RUBBERBANDGAMES",
    descripcion: "Un sandbox de mundo abierto donde todo se mueve por física y los personajes son muñecos de trapo. Se consiguen trabajos, se junta plata y se hace desastre, solo o en línea con amigos.",
    trailer: "https://youtube.com/embed/2invlS5ks04",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1211020/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-08-17"
  },
  {
    id: "1000xresist",
    titulo: "1000xRESIST",
    relanzamiento: "En PC desde mayo de 2024",
    duracion: "≈ 11 h (historia) · 14 h (completo)",
    fecha: "2026-08-20",
    plataformas: ["SWITCH2"],
    genero: ["AVENTURA", "INDIE", "NOVELA VISUAL"],
    desarrollador: "SUNSET VISITOR",
    descripcion: "Una aventura de ciencia ficción en un año que nadie sabe cuál es, con la humanidad encerrada bajo tierra por una enfermedad que trajo una invasión alienígena. Se juega como Watcher, una de las hermanas clonadas que sirven a la Todopoderosa.",
    trailer: "https://youtube.com/embed/ISmiWUpiDs4",
    metacritic: 86,
    metacriticUsuarios: 7.9,
    metacriticVotos: 133,
    critica: "El acuerdo es raro por lo alto y por lo unánime: la prensa lo trata como una de las mejores historias que dio el medio en años, una ciencia ficción sobre memoria, identidad cultural y herencia que casi ninguna reseña logra resumir sin decir que hay que jugarlo. Los elogios van a la escritura, a los ambientes y a cómo cambia de perspectiva. El reparo también se repite y es el mismo: como juego es poca cosa, más cerca de una novela visual, con conversaciones que se estiran. Ninguna reseña lo considera motivo suficiente para no jugarlo.",
    ...
    noticias: [
      {
        fecha: "2026-08-20",
        titulo: "DEBUTA CON 86 Y LA CRÍTICA HABLA DE LA HISTORIA, NO DEL JUEGO",
        texto: "Llega hoy a Switch 2 con 86 de crítica. Lo llamativo es en qué coinciden las reseñas: casi todas elogian la historia por encima de todo y casi todas aclaran que como juego es poca cosa. Hay notas de 95 y de 100 que dicen las dos cosas a la vez."
      },
      {
        fecha: "2026-08-19",
  ...
  },
  {
    ...
    titulo: "GHETTO ZOMBIES: GRAFFITI SQUAD",
    relanzamiento: "En PC desde enero de 2026",
    duracion: "≈ 5 h (historia)",
    fecha: "2026-08-27",
    plataformas: ["PS5", "SWITCH2", "PS4"],
    genero: ["ACCION", "CASUAL", "INDIE"],
    desarrollador: "FOGO GAMES",
    descripcion: "Un shooter de vista cenital donde los zombis explotan en baba verde que va pintando la pantalla, con un arsenal desmedido y estética de grafiti.",
    trailer: "https://youtube.com/embed/bdOUjhmwhFk",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3047820/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-08-17"
  },
  {
    ...
    duracion: "≈ 1,4 h (historia) · 3,7 h (completo)",
    fecha: "2026-09-04",
    plataformas: ["XBOX", "PS5"],
  ...
  },
  {
    ...
    titulo: "PATLABOR THE CASE FILES",
    fecha: "2026-09-17",
    plataformas: ["PS5"],
    genero: ["ACCION", "ANIME", "AVENTURA"],
    desarrollador: "CHIME",
    descripcion: "Un juego de acción en 3D que recorre escenas emblemáticas de Mobile Police Patlabor, alternando la perspectiva de los pilotos de robots y la de los policías a pie.",
    trailer: "https://youtube.com/embed/R_4kqMHnlrg",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cobteq.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-08-17"
  },
  {
    id: "remothered-red-nuns-legacy",
    titulo: "REMOTHERED: RED NUN'S LEGACY",
    fecha: "2026-10-27",
    plataformas: ["PS5", "XBOX"],
    genero: ["TERROR", "AVENTURA", "ACCION"],
    desarrollador: "STORMIND GAMES",
    descripcion: "Secuestraron a tu hija. La búsqueda te mete en una pesadilla de la que hay que salir vivo mientras se destapa la verdad detrás de la monja roja.",
    trailer: "https://youtube.com/embed/PEBcT6E6u6c",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cobrbr.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-08-17"
  },
  ...
  },
  {
    ...
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc954.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-08-18"
  },
...

  {
    ...
    plataformas: ["SWITCH", "XBOX"],
    genero: ["ACCION", "AVENTURA", "RPG"],
    desarrollador: "JOHN PYWELL",
    descripcion: "Un mundo antiguo e interconectado que se descubre peleando: el combate exige precisión y cada zona nueva se gana a pulso. Es la obra de un solo desarrollador, John Pywell, con años de trabajo encima.",
    trailer: "https://youtube.com/embed/IDxNTwxgt6I",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1841240/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-08-28"
  },

  {
    ...
    fecha: "2026-09-17",
    plataformas: ["SWITCH", "PS5"],
    genero: ["TABLERO", "ESTRATEGIA", "CASUAL"],
    desarrollador: "MONSTER COUCH",
    descripcion: "La adaptación del juego de mesa de Manny Vega, para uno a cinco jugadores. Sos guardallamas y tenés que encontrarles el local ideal a los dragones artesanos, que encantan las tiendas del pueblo. Amable, corto y de reglas simples.",
    trailer: "https://youtube.com/embed/A0zHLHLjyRU",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/co9sh0.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-08-28"
  },

  {
    ...
    desarrollador: "INVISIBLE STUDIO",
    descripcion: "Año 2071: Tristan recupera conciencias humanas resolviendo puzles. Un mundo neón-noir de estética low poly noventosa, donde lo que se investiga en cada entorno cambia el final.",
    trailer: "https://youtube.com/embed/p7UqAQiqMII",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3079600/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-08-28"
  },

  {
    ...
    titulo: "THE WITCHER 3: WILD HUNT — REMASTERED",
    duracion: "≈ 52 h (historia) · 175 h (completo)",
    relanzamiento: "El original salió en 2015 para PS4, Xbox One y PC — esta fecha corresponde a la edición remasterizada de Switch 2",
    fecha: "2026-09-29",
    plataformas: ["SWITCH2"],
    genero: ["RPG", "MUNDO ABIERTO", "ACCION"],
  ...
  {
    id: "train-sim-world-7",
    titulo: "TRAIN SIM WORLD 7",
    fecha: "2026-09-15",
    plataformas: ["PS5", "XBOX"],
    genero: ["SIMULACION"],
    desarrollador: "DOVETAIL GAMES",
    descripcion: "La entrega anual del simulador de trenes de Dovetail. Rutas reales licenciadas, cabinas modeladas al detalle y la opción de manejar en serio o simplemente pasear mirando el paisaje.",
    trailer: "https://youtube.com/embed/hXKOGV8h6J8",
    metacritic: 81,
    metacriticUsuarios: null,
...

  {
    ...
    titulo: "GRAVEYARD KEEPER 2",
    fecha: "2026-09-22",
    plataformas: ["PS5", "XBOX"],
    genero: ["SIMULACION", "AVENTURA", "RPG"],
...

  {
    ...
    fecha: "2026-10-13",
    plataformas: ["XBOX"],
    genero: ["AVENTURA", "PUZZLE", "PLATAFORMA"],
    desarrollador: "BEHOLD STUDIOS",
    descripcion: "Exploración y supervivencia en una mazmorra hecha a mano, con puzles, fabricación y estructura de metroidvania. Se puede jugar solo o en cooperativo en línea.",
    trailer: "https://youtube.com/embed/HtN_PLudTUk",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2871520/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-08-28"
  },
  ...
  {
    id: "power-racing-bundle-4",
    titulo: "POWER RACING BUNDLE 4",
    fecha: "2026-12-25",
    plataformas: ["SWITCH"],
    genero: ["CARRERAS", "DEPORTES", "SIMULACION"],
    desarrollador: "SUPERPOWERUPGAMES",
    descripcion: "Cuatro juegos de carreras en un solo paquete, el cuarto de una serie que SuperPowerUpGames viene armando desde 2020. Es de los baratos de la eShop, sin pretensiones: sirve para tener algo rápido a mano.",
    trailer: null,
    metacritic: null,
    imagen: "https://www.nintendo.com/eu/media/images/assets/nintendo_switch_games/powerracingbundle4/1x1_PowerRacingBundle4_image500w.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-08-31"
  },
  {
    ...
    duracion: "≈ 3,6 h (historia) · 4,2 h (completo)",
    fecha: "2026-09-01",
    plataformas: ["XBOX"],
    genero: ["AVENTURA", "SIMULACION", "RELAX", "CASUAL"],
    desarrollador: "GAGONFE",
    ...
    trailer: "https://youtube.com/embed/B-3eTsz5Zpo",
    metacritic: null,
  ...
  {
    id: "port-of-jumanah",
    titulo: "PORT OF JUMANAH",
    fecha: "2026-09-07",
    plataformas: ["PS5"],
    genero: ["ACCION", "AVENTURA", "ROGUELIKE", "INDIE"],
    desarrollador: "RED DUNES GAMES",
    descripcion: "Acción en 2.5D con estructura rogue-lite y una ambientación de mundo árabe que no se ve seguido. Se juega como Mansour, un pibe que termina metido en un viaje para salvar el mundo sin haberlo pedido. Se reclutan compañeros para el barco —hay un gato— y cada uno cambia algo de la travesía.",
    trailer: "https://youtube.com/embed/EcDH8eoPN5k",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2998920/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-02"
  },
  {
    id: "aerial-knights-mr-freezy",
    titulo: "AERIAL_KNIGHT'S MR FREEZY",
    relanzamiento: "En PC desde septiembre de 2026",
    fecha: "2026-09-08",
    plataformas: ["PS5"],
    genero: ["PUZZLE", "INDIE", "HORROR"],
    desarrollador: "AERIAL_KNIGHT",
    descripcion: "Un juego de puzles con humor negro sobre una asesina serial que la ciudad de New Detroit conoce como Mr. Freezy, después de encontrar cientos de cabezas guardadas en heladeras. No se juega a las víctimas: se juega del otro lado del sótano. Lo hace Aerial_Knight, el estudio de una sola persona detrás de Never Yield.",
    trailer: "https://youtube.com/embed/MZGl4IMvnDA",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4756010/edee0d22445bfc4685f19fd2ce967710c198efb8/header.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-02"
  },
  {
    id: "the-royal-writ",
    titulo: "THE ROYAL WRIT",
    relanzamiento: "En PC desde agosto de 2025",
    duracion: "≈ 3,5 h (historia)",
    fecha: "2026-09-10",
    plataformas: ["XBOX", "SWITCH"],
    genero: ["ESTRATEGIA", "CARTAS", "ROGUELIKE", "INDIE"],
    desarrollador: "SAVE SLOTH STUDIOS",
    ...
    trailer: "https://youtube.com/embed/VGMStPU_WcY",
    metacritic: 80,
    metacriticUsuarios: null,
    ...
    gamepass: true,
    psplus: false,
    critica: "Un roguelike de armar mazos que las reseñas describen igual: agarra ideas conocidas y las cruza de una forma que no se había visto, con carriles, movimiento y palabras clave que hay que combinar para pegar fuerte. Coinciden en que no te lleva de la mano y en que la profundidad recién se ve después de varias partidas. El reparo que aparece es que a veces la partida se termina por algo que no se puede prever ni responder.",
    alta: "2026-09-02",
    noticias: [
      {
        fecha: "2026-09-10",
        titulo: "DEBUTA CON 80 Y ENTRA A GAME PASS EL PRIMER DÍA",
        texto: "El roguelike de mazos sale hoy con 80 y está en Game Pass desde el estreno. Las reseñas destacan que cruza ideas conocidas de una forma nueva, y avisan que no explica nada: la profundidad aparece recién después de varias partidas."
      }
    ]
  },
  {
    ...
    trailer: "https://youtube.com/embed/nI4grkd3v_E",
    metacritic: null,
  ...
  },
  {
    ...
    fecha: "2026-09-04",
    plataformas: ["PS5", "XBOX"],
    genero: ["DEPORTES", "SIMULACION", "MULTIJUGADOR"],
    ...
    noticias: [
      {
        fecha: "2026-09-04",
        titulo: "DEBUTA CON 65 Y LAS RESEÑAS APUNTAN AL MODO DE CARTAS",
        texto: "El hockey mejoró respecto del año pasado, pero eso no alcanzó. El reproche que más se repite en las seis reseñas es el Hockey Ultimate Team: aparece a los pocos minutos con ventanas emergentes y varios medios lo describen como el centro real del juego."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    titulo: "MEWGENICS",
    relanzamiento: "En PC desde febrero de 2026",
    duracion: "≈ 82 h (historia) · 284 h (completo)",
    fecha: "2026-09-08",
    plataformas: ["PS5", "XBOX", "SWITCH2"],
    genero: ["ESTRATEGIA", "ROGUELIKE", "POR TURNOS", "INDIE"],
    desarrollador: "EDMUND MCMILLEN GAMES",
    ...
    noticias: [
      {
        fecha: "2026-09-08",
        titulo: "DEBUTA CON 88, EL MEJOR PUNTAJE DEL MES HASTA HOY",
        texto: "Llega a PS5, Xbox y Switch 2 el roguelike de gatos de Edmund McMillen, el de The Binding of Isaac. Estuvo trece años en desarrollo y en PC salió en febrero con 88 sobre casi sesenta reseñas. El elogio es a la escala —doscientas horas de contenido, cien jefes— y al sistema de cruza, que hace que cada camada arrastre lo que dejó la anterior."
      }
    ]
  },
  {
    id: "granblue-fantasy-versus-rising-switch-2",
    titulo: "GRANBLUE FANTASY VERSUS: RISING",
    relanzamiento: "En PS5, PS4 y PC desde diciembre de 2023 — esta fecha corresponde a la edición de Switch 2",
    duracion: "≈ 12 h (historia)",
    fecha: "2026-09-17",
    plataformas: ["SWITCH2"],
    genero: ["LUCHA", "ACCION", "ANIME", "MULTIJUGADOR"],
    desarrollador: "ARC SYSTEM WORKS",
    descripcion: "El juego de pelea de Granblue Fantasy hecho por Arc System Works, los de Guilty Gear, llega a Switch 2. Está pensado para entrar sin saber pelear: hay un esquema de controles simplificado que saca los especiales con un botón, y otro clásico para quien quiera la ejecución completa. Trae rollback y juego cruzado.",
    trailer: "https://youtube.com/embed/SbI26Ehde3g",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2157560/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-03"
  },
  {
    id: "mad-king-redemption",
    titulo: "MAD KING REDEMPTION",
    relanzamiento: "En PC, en acceso anticipado, desde mayo de 2026",
    fecha: "2026-09-23",
    plataformas: ["XBOX"],
    genero: ["ACCION", "ROGUELIKE", "RETRO", "INDIE"],
    desarrollador: "SECRET MISSION",
    descripcion: "Un beat 'em up roguelite en pixel art sobre escenarios 2.5D. El rey perdió la cordura intentando revivir a la reina con magia prohibida, y cuatro héroes, cada uno con su estilo de pelea y un pecado propio que redimir, bajan a buscarlo. Cada partida cambia, y entre una y otra se desbloquean héroes, golpes y artefactos.",
    trailer: "https://youtube.com/embed/g9MIja4Q-Ck",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2369580/library_600x900.jpg",
    noticias: [
      {
        fecha: "2026-09-21",
        titulo: "YA ESTÁ EN XBOX, Y HOY ENTRA EN GAME PASS",
        texto: "Secret Mission lo sacó en Xbox el 21 de septiembre y avisó que entraba en Game Pass el 23. Venía de cuatro meses de acceso anticipado en PC, donde la última actualización grande sumó progresión, historia, esbirros, reliquias y varias ranuras de guardado."
      }
    ],
    gamepass: true,
    psplus: false,
  ...
  },
  {
    ...
    fecha: "2026-09-23",
    plataformas: ["XBOX"],
    genero: ["PUZZLE", "PLATAFORMA", "AVENTURA", "INDIE"],
    desarrollador: "ENCHANTED WORKS",
    descripcion: "Kiko queda atrapada en un mundo de espíritus donde las leyes físicas se pueden torcer. Se colocan portales para cambiar de dirección la gravedad —de los objetos y de ella misma—, se manipula el paso del tiempo y se combinan poderes de los espíritus para resolver los puzles del entorno. Cuatro zonas, una por estación, con sus propias mecánicas, y niveles a los que conviene volver cuando aparecen poderes nuevos.",
    trailer: "https://youtube.com/embed/VXRHeRAdI5Q",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2932680/library_600x900.jpg",
    noticias: [
      {
        fecha: "2026-09-10",
        titulo: "SALE EL 23 DE SEPTIEMBRE",
        texto: "Enchanted Works confirmó la fecha después de un año largo de desarrollo final, puliendo niveles, puntos de control y cámaras de las escenas. El juego se había mostrado en abril en el INDIE Live Expo."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  {
    id: "resident-evil-2-switch-2",
    titulo: "RESIDENT EVIL 2: DELUXE EDITION",
    duracion: "≈ 8,9 h (historia) · 37 h (completo)",
    relanzamiento: "En PS4, Xbox y PC desde enero de 2019 — esta fecha corresponde a la edición de Switch 2",
    fecha: "2026-10-16",
    plataformas: ["SWITCH2"],
    genero: ["HORROR", "ACCION", "AVENTURA"],
    desarrollador: "CAPCOM CO., LTD.",
    descripcion: "El rehecho del clásico de 1998, ahora en Switch 2. Leon Kennedy y Claire Redfield llegan a Raccoon City el día que todo se cae a pedazos, con cámara al hombro y munición contada. El Tyrant persigue por los pasillos de la comisaría y no se lo puede matar, sólo demorar. La edición Deluxe suma los trajes y los extras que salieron aparte.",
    trailer: "https://youtube.com/embed/4C10U-O1kZ8",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/883710/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    id: "resident-evil-3-switch-2",
    titulo: "RESIDENT EVIL 3",
    relanzamiento: "En PS4, Xbox y PC desde abril de 2020 — esta fecha corresponde a la edición de Switch 2",
    duracion: "≈ 6 h (historia) · 20 h (completo)",
    fecha: "2026-10-16",
    plataformas: ["SWITCH2"],
    genero: ["HORROR", "ACCION", "AVENTURA"],
    desarrollador: "CAPCOM CO., LTD.",
    descripcion: "Jill Valentine intenta salir de Raccoon City mientras Umbrella le suelta atrás a Nemesis, que la persigue por toda la ciudad y no para. Es más de acción y más corto que el rehecho de Resident Evil 2, con esquive en lugar de aguantar el golpe. Trae adentro Resident Evil Resistance, el multijugador asimétrico de cuatro contra uno.",
    trailer: "https://youtube.com/embed/4C10U-O1kZ8",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/952060/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    id: "resident-evil-4-switch-2",
    titulo: "RESIDENT EVIL 4: GOLD EDITION",
    duracion: "≈ 16 h (historia) · 65 h (completo)",
    relanzamiento: "En PS5, PS4, Xbox y PC desde marzo de 2023 — esta fecha corresponde a la edición de Switch 2",
    fecha: "2026-10-16",
    plataformas: ["SWITCH2"],
    genero: ["HORROR", "ACCION", "AVENTURA"],
    desarrollador: "CAPCOM CO., LTD.",
    descripcion: "Leon vuelve a la aldea a buscar a la hija del presidente, y el rehecho de 2023 es de los mejor recibidos que hizo Capcom: mantiene el ritmo del original de 2005 y le suma parry con el cuchillo y un sigilo que antes no estaba. La edición Gold trae el juego completo, el episodio de Ada y todo lo que salió después.",
    trailer: "https://youtube.com/embed/4C10U-O1kZ8",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2050650/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    id: "marvels-guardians-of-the-galaxy-switch-2",
    titulo: "MARVEL'S GUARDIANS OF THE GALAXY: ENCORE EDITION",
    duracion: "≈ 18 h (historia) · 26 h (completo)",
    relanzamiento: "En PS5, PS4, Xbox y PC desde octubre de 2021 — esta fecha corresponde a la edición de Switch 2",
    fecha: "2026-11-05",
    plataformas: ["SWITCH2"],
    genero: ["ACCION", "AVENTURA"],
    desarrollador: "EIDOS-MONTRÉAL",
    descripcion: "Se juega solamente como Star-Lord y a los otros cuatro Guardianes se los manda en combate, que es lo que lo hace distinto de un juego de superhéroes común. La otra mitad son las decisiones de diálogo, que cambian cómo te trata el equipo. Salió en 2021 con muy buenas críticas y quedó como una de las sorpresas de aquel año.",
    trailer: "https://youtube.com/embed/y6W0u0eAdv8",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1088850/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    id: "pikmin-4-switch-2",
    titulo: "PIKMIN 4 — NINTENDO SWITCH 2 EDITION + ACADEMIA DANDORI",
    duracion: "≈ 18 h (historia) · 40 h (completo)",
    relanzamiento: "En Switch desde julio de 2023 — esta fecha corresponde a la edición de Switch 2",
    fecha: "2026-11-12",
    plataformas: ["SWITCH2"],
    genero: ["ESTRATEGIA", "AVENTURA"],
    desarrollador: "NINTENDO",
    descripcion: "La edición de Switch 2 del cuarto Pikmin, el que sumó a Oatchi, el perro que carga y pelea. Lo nuevo acá es que a Oatchi se le dan órdenes con la voz, usando el micrófono de la consola, y que viene Academia Dandori, un modo aparte para practicar la organización de tareas que es el corazón de la saga.",
    trailer: "https://youtube.com/embed/DcXX_Ic1aR8",
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/2e43c4664011d4b9c90d583a4897beb6.png",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    ...
    relanzamiento: "En PS5, Xbox y PC desde febrero de 2025 — esta fecha corresponde a la edición de Switch 2",
    duracion: "≈ 18 h (historia) · 115 h (completo)",
    fecha: "2026-12-04",
    plataformas: ["SWITCH2"],
    genero: ["ACCION", "RPG", "COOP"],
    desarrollador: "CAPCOM CO., LTD.",
    descripcion: "El Monster Hunter de 2025 llega a Switch 2. Lo que lo separa de los anteriores es que el mundo cambia solo: las tormentas y las estaciones alteran el terreno y el comportamiento de los monstruos en medio de la cacería. Se juega en cooperativo de hasta cuatro y el ciclo de siempre sigue intacto — cazar, hacerse el equipo con lo que dejó el monstruo, cazar algo más grande.",
    trailer: "https://youtube.com/embed/4vEnGRYRFS4",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2246340/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    ...
    fecha: "2026-10-15",
    plataformas: ["PS5", "PS4", "XBOX", "SWITCH2", "SWITCH"],
    genero: ["AVENTURA", "CASUAL", "RELAX"],
    desarrollador: "GAMELOFT",
    descripcion: "Un juego de sacar fotos con Bluey y Bingo por los lugares que aparecen en la serie. Se recorre, se busca qué retratar y se arma un álbum propio. Está pensado para chicos y para jugarlo al lado de ellos, sin fallar ni perder.",
  ...
  {
    id: "lego-harry-potter-collection-switch-2",
    titulo: "LEGO HARRY POTTER COLLECTION",
    relanzamiento: "En consolas desde 2016 y remasterizado en 2024 — esta fecha corresponde a la edición de Switch 2",
    duracion: "≈ 26 h (historia) · 53 h (completo)",
    fecha: "2026-10-16",
    plataformas: ["SWITCH2"],
    genero: ["ACCION", "AVENTURA", "COOP"],
    desarrollador: "TT GAMES",
    descripcion: "Los dos juegos de LEGO Harry Potter en un paquete: Años 1-4 y Años 5-7, o sea las siete películas completas. Es la fórmula LEGO de siempre —romper todo, resolver puzles simples y coleccionar— con cooperativo local a pantalla partida, que es como mejor funciona.",
    trailer: "https://youtube.com/embed/DSdF1hhuHWY",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2950340/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    id: "stellar-blade-switch-2",
    titulo: "STELLAR BLADE: COMPLETE EDITION",
    duracion: "≈ 23 h (historia) · 57 h (completo)",
    relanzamiento: "En PS5 desde abril de 2024 y en PC desde junio de 2025 — esta fecha corresponde a la edición de Switch 2",
    fecha: "2026-11-05",
    plataformas: ["SWITCH2"],
    genero: ["ACCION", "AVENTURA", "RPG"],
    desarrollador: "SHIFT UP CORPORATION",
    descripcion: "EVE baja a una Tierra arrasada a pelearle a los Naytiba. El combate es de parry y contraataque, más cerca de un Nier o un Bayonetta que de un soulslike, y fue lo más elogiado cuando salió en PS5 en 2024. La edición Complete trae el juego con todo lo que se le agregó después.",
    trailer: "https://youtube.com/embed/r7FaHEZZaAo",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/co9wcx.jpg",
    noticias: [
      {
        fecha: "2026-09-20",
        titulo: "YA SE PUEDE PROBAR EN SWITCH 2, Y LLEGA EL CRUCE CON BAYONETTA",
        texto: "La demo de la edición de Switch 2 ya está en la eShop. SHIFT UP además mostró un video de la colaboración con Bayonetta, que es una actualización gratuita, y Nintendo publicó su propio tráiler para la consola."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    fecha: "2027-01-15",
    plataformas: ["PS5"],
    genero: ["ACCION", "AVENTURA", "SUPERVIVENCIA"],
    desarrollador: "ALPHA CHANNEL",
    descripcion: "Un juego de acción en un páramo lleno de monstruos mecánicos, después de una guerra que arrasó con todo. Se controla a Whitaker, una conciencia digital metida en un dron blindado que rescata y maneja tanques de una época perdida. Lo que se desarma de los enemigos se usa para reconstruirse, con la meta de llegar a Highpoint.",
    trailer: "https://youtube.com/embed/RtZDfIqxbYE",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cob0ej.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-17"
  },
  {
    ...
    titulo: "STRANGER THAN HEAVEN",
    fecha: "2027-01-15",
    plataformas: ["PS5", "XBOX"],
    genero: ["ACCION", "AVENTURA", "RPG"],
    desarrollador: "RGG STUDIO",
    descripcion: "Lo nuevo del estudio de Yakuza: una historia de cincuenta años sobre gente que no tiene adónde ir. Arranca en San Francisco en 1915, cuando Makoto Daito, hijo de padre estadounidense y madre japonesa, se sube de polizón a un barco para viajar a la tierra de su madre, y recorre cinco épocas y cinco ciudades con combate cuerpo a cuerpo.",
  ...
  {
    id: "wandering-sword",
    titulo: "WANDERING SWORD",
    relanzamiento: "En PC desde septiembre de 2023 — esta fecha corresponde a la edición de PS5",
    duracion: "≈ 43 h (historia) · 99 h (completo)",
    fecha: "2027-01-21",
    plataformas: ["PS5"],
    genero: ["RPG", "RETRO", "INDIE"],
    desarrollador: "THE SWORDMAN STUDIO",
    descripcion: "Un RPG de artes marciales chinas, del género wuxia, con personajes en pixel art sobre escenarios en 3D. Un joven envenenado por quedar en medio de la pelea entre dos sectas sale a aprender artes marciales, en un recorrido por más de setenta lugares de la China antigua.",
    trailer: null,
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1876890/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-17"
  },
  {
    ...
    descripcion: "La vuelta de El Presidente, el dictador con humor de la saga Tropico. Se construye una nación en un archipiélago, se la lleva a través de los siglos y esta vez se puede, literalmente, mover montañas, sin olvidarse de la cuenta en Suiza.",
    trailer: "https://youtube.com/embed/6KXyO3uaFRk",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coab61.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-17"
  },
  {
    id: "metroid-ravenous",
    titulo: "METROID RAVENOUS",
    fecha: "2027-01-28",
    plataformas: ["SWITCH2"],
    genero: ["ACCION", "AVENTURA", "PLATAFORMA"],
    desarrollador: "NINTENDO",
    descripcion: "Samus Aran vuelve en el primer Metroid pensado para Switch 2, anunciado en el Direct de septiembre de 2026 con fecha ya puesta. Nintendo mostró poco: un planeta nuevo, la exploración y el rastreo de siempre, y algo que devora lo que toca.",
    trailer: "https://youtube.com/embed/2fezEO5knDg",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocvb8.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    ...
    titulo: "TOMB RAIDER: LEGACY OF ATLANTIS",
    fecha: "2027-02-12",
    plataformas: ["PS5", "XBOX", "SWITCH2"],
    genero: ["ACCION", "AVENTURA", "PLATAFORMA"],
    desarrollador: "CRYSTAL DYNAMICS",
    descripcion: "Lara Croft en una Grecia reimaginada, buscando lo que quedó de la Atlántida. Vuelve el peso en la exploración y en las tumbas con puzles, que es de donde salió la saga, con el combate más atrás que en la trilogía anterior.",
    trailer: "https://youtube.com/embed/Hl-n_o0xg6U",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cob1kg.jpg",
    noticias: [
      {
        fecha: "2026-09-24",
        titulo: "SALE EL 12 DE FEBRERO, Y TAMBIÉN EN PS5 Y XBOX",
        texto: "Sale el 12 de febrero de 2027 en las tres consolas. El 10 es el acceso anticipado de la edición Deluxe, que en Switch 2 empieza dos días antes. La PlayStation Store y la tienda de Xbox ya lo tienen en preventa para ese mismo día."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  {
    id: "god-of-war-laufey",
    titulo: "GOD OF WAR: LAUFEY",
    fecha: "2027-02-16",
    plataformas: ["PS5"],
    genero: ["ACCION", "AVENTURA"],
    desarrollador: "SANTA MONICA STUDIO",
    descripcion: "Un God of War protagonizado por Laufey, conocida como Faye, la madre de Atreus y esposa de Kratos. Después de su muerte despierta en un más allá desconocido y recorre el Everywhen para proteger a los dos.",
  ...
  },
  {
    ...
    titulo: "ROMANCING SAGA 3: DESTINIES UNITED",
    relanzamiento: "El original de Super Nintendo es de 1995 y se remasterizó en 2019 — esta es la edición nueva",
    fecha: "2027-02-16",
    plataformas: ["SWITCH2", "SWITCH", "PS5", "XBOX"],
    genero: ["RPG", "POR TURNOS", "RETRO"],
    desarrollador: "SQUARE ENIX",
    descripcion: "El tercer Romancing SaGa, el de 1995 que en su momento no salió de Japón. Se elige entre ocho protagonistas y cada uno arma su propia versión de la historia, con un sistema de combate donde las habilidades se aprenden peleando y no subiendo de nivel.",
    trailer: "https://youtube.com/embed/n1SOFPOXizc",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocv98.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    ...
    titulo: "YU-GI-OH! TAG FORCE GX",
    fecha: "2027-02-16",
    plataformas: ["SWITCH2", "SWITCH"],
    genero: ["CARTAS", "ANIME", "RPG"],
    desarrollador: "KONAMI",
    descripcion: "La vuelta de los Tag Force, los Yu-Gi-Oh! de PSP donde además de duelar se hace vida en la Academia de Duelos: se elige compañero, se lo conoce y se pelea en parejas. Está basado en la etapa GX de la serie.",
    trailer: "https://youtube.com/embed/DzGpTjuzelg",
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/51b965345d109e3521a8e4196aa2e484.png",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    ...
    titulo: "PERSONA 4 REVIVAL",
    fecha: "2027-02-18",
    plataformas: ["PS5", "XBOX"],
    genero: ["RPG", "POR TURNOS", "ANIME"],
    desarrollador: "ATLUS",
    descripcion: "La remake completa de Persona 4. En Inaba, un pueblo tranquilo de Japón, aparecen cadáveres después de que en las noches de lluvia se emite un programa misterioso, el Canal de Medianoche. Un grupo de estudiantes investiga los crímenes mientras vive su año escolar.",
    trailer: "https://youtube.com/embed/ggL7FAdUGJg",
    metacritic: null,
    ...
    noticias: [
      {
        ...
        texto: "ATLUS emitió el segundo episodio del Persona 4 Revival Broadcast, dedicado a los integrantes del equipo de investigación y a contenido nuevo. Las reservas ya están abiertas en PS5 y Xbox, y la edición de Switch 2 sigue anunciada para el 20 de mayo de 2027."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    descripcion: "El regreso de Fable, con un nuevo comienzo a cargo de Playground Games, los de Forza Horizon. Un RPG de acción en un mundo abierto de Albión donde cada decisión cambia el recorrido y la reputación lo es todo, con el humor negro de siempre y ningún final feliz garantizado.",
    trailer: "https://youtube.com/embed/3iW1i78zFvk",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2769570/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-17"
  },
  {
    id: "hyrule-warriors-age-of-calamity-definitive-edition",
    titulo: "HYRULE WARRIORS: LA ERA DEL CATACLISMO — EDICIÓN DEFINITIVA",
    duracion: "≈ 25 h (historia) · 77 h (completo)",
    relanzamiento: "En Switch desde noviembre de 2020 — esta fecha corresponde a la edición de Switch 2",
    fecha: "2027-02-25",
    plataformas: ["SWITCH2"],
    genero: ["ACCION", "HACK AND SLASH"],
    desarrollador: "KOEI TECMO",
    descripcion: "El musou ambientado cien años antes de Breath of the Wild, con la batalla contra el Cataclismo que en aquel juego sólo se contaba. La edición definitiva junta el juego con todo el contenido descargable que salió después.",
    trailer: "https://youtube.com/embed/O8-SknQHS2Y",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocv9v.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    ...
    titulo: "MELTY BLOOD: TWI-LUMINA",
    fecha: "2027-04-21",
    plataformas: ["PS5", "XBOX"],
    genero: ["LUCHA", "ANIME"],
    desarrollador: "FRENCH-BREAD",
    descripcion: "La continuación de Melty Blood: Type Lumina, el juego de pelea en 2D basado en Tsukihime. Suma personajes nuevos y ajusta el sistema de combate, con French-Bread otra vez a cargo.",
    trailer: "https://youtube.com/embed/901ronfe540",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc0bg.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-14"
  },
  {
    id: "final-fantasy-vii-revelation",
    titulo: "FINAL FANTASY VII REVELATION",
    fecha: "2027-04-08",
    plataformas: ["PS5", "XBOX", "SWITCH2"],
    genero: ["RPG", "ACCION", "AVENTURA"],
    desarrollador: "SQUARE ENIX",
    descripcion: "El cierre de la trilogía que empezó con Remake y siguió con Rebirth. Square Enix lo anunció para el 8 de abril de 2027 en el State of Play de septiembre, y en el Direct confirmó que también sale en Switch 2 el mismo día.",
    trailer: "https://youtube.com/embed/Ug2-GO6s64Q",
    metacritic: null,
  ...
  },
  {
    ...
    descripcion: "Una de las dos mitades de la décima generación de Pokémon, la primera pensada para Switch 2. Se anunció junto a Pokémon Waves y, como siempre en la saga, cada versión tiene sus propios Pokémon exclusivos. Nintendo confirmó 2027 y todavía no dio día.",
    trailer: "https://youtube.com/embed/wzJWH9X3Lxc",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cobo9k.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    ...
    genero: ["RPG", "AVENTURA"],
    desarrollador: "GAME FREAK",
    descripcion: "La otra mitad de la décima generación, hermana de Pokémon Winds. Comparten mundo e historia y se diferencian en qué Pokémon aparecen en cada una, que es la fórmula de la saga desde Rojo y Azul. Sale en 2027, sin día confirmado.",
    trailer: "https://youtube.com/embed/wzJWH9X3Lxc",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cobo9j.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    ...
    genero: ["RPG", "MUNDO ABIERTO", "ACCION"],
    desarrollador: "MONOLITH SOFT",
    descripcion: "Lo nuevo de Monolith Soft para Switch 2, y por el nombre parece un punto de partida más que una cuarta parte. De momento Nintendo mostró poco: mundos enormes, combate en tiempo real y el sello de la saga, que es dejarte caminar horas antes de que la historia arranque en serio.",
    trailer: "https://youtube.com/embed/_oOib9ILoUc",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc8ai.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    id: "kirby-and-the-world-beyond",
    titulo: "KIRBY AND THE WORLD BEYOND",
    fecha: "2027-06-30",
    estimado: true,
    fechaEstimada: "SEGUNDO TRIMESTRE 2027",
    plataformas: ["SWITCH2"],
    ...
    descripcion: "El Kirby en tres dimensiones que sigue a Forgotten Land, con las habilidades de copia de siempre y un mundo abierto para recorrer. Nintendo lo anunció para la primavera boreal de 2027, o sea alrededor de mayo, sin día todavía.",
    trailer: "https://youtube.com/embed/ozLDuA0pN5Y",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocvba.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    ...
    genero: ["RPG", "ACCION", "AVENTURA"],
    desarrollador: "SQUARE ENIX",
    descripcion: "Sora despierta en Quadratum, una ciudad que parece el Tokio real, y desde ahí arranca la cuarta parte numerada. Square Enix la anunció para fines de 2027 y viene mostrando mundos de a poco, entre ellos el de Coco.",
    trailer: "https://youtube.com/embed/lybMpYeO9L8",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocp35.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    id: "spyro-a-realm-beyond",
    titulo: "SPYRO: A REALM BEYOND",
    fecha: "2027-12-31",
    estimado: true,
    fechaEstimada: "2027",
    plataformas: ["PS5", "XBOX", "SWITCH2"],
    ...
    descripcion: "El primer Spyro nuevo desde los noventa, sin contar la trilogía rehecha de 2018. Vuelve el plataformas de recorrer mundos abiertos volando y planeando, hecho por el mismo estudio que hizo aquella trilogía.",
    trailer: "https://youtube.com/embed/pQlenskhoxI",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc7e0.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    id: "resident-evil-veronica",
    titulo: "RESIDENT EVIL VERONICA",
    fecha: "2027-12-31",
    estimado: true,
    fechaEstimada: "2027",
    plataformas: ["PS5", "XBOX", "SWITCH2"],
    genero: ["HORROR", "ACCION", "AVENTURA"],
    desarrollador: "CAPCOM CO., LTD.",
    descripcion: "Capcom rehace Code: Veronica, el de 2000 que en su momento salió en Dreamcast y que quedó como el eslabón que faltaba entre el segundo y el cuarto. Claire Redfield busca a su hermano y termina en una isla prisión de Umbrella.",
    trailer: "https://youtube.com/embed/f-HSqQjowBg",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocsoe.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    id: "lego-skylines",
    titulo: "LEGO SKYLINES",
    fecha: "2027-12-31",
    estimado: true,
    fechaEstimada: "2027",
    plataformas: ["PS5", "XBOX", "SWITCH2"],
    genero: ["SIMULACION", "ESTRATEGIA", "CASUAL"],
    desarrollador: "ICEFLAKE STUDIOS",
    descripcion: "Cities: Skylines con piezas de LEGO, hecho por Paradox junto a la marca. Se construye una ciudad con bloques que encajan, así que la simulación de siempre queda envuelta en algo más simple y más de armar que de administrar.",
    trailer: "https://youtube.com/embed/4s7Sv_7dBZo",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocriw.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    ...
    fechaEstimada: "2027",
    plataformas: ["SWITCH2"],
    genero: ["AVENTURA", "PUZZLE", "PLATAFORMA", "INDIE"],
    desarrollador: "SECTORDUB",
    descripcion: "La secuela del absurdo de Devolver, aquel de las piernas larguísimas y el humor seco. Vuelve la exploración con puzles en un mundo de colores planos, ahora con una resistencia de por medio.",
    trailer: "https://youtube.com/embed/qWB73ZGDMJA",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc7ob.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    id: "cairn-switch-2",
    titulo: "CAIRN",
    relanzamiento: "En PS5 y PC desde 2025 — esta fecha corresponde a la edición de Switch 2",
    duracion: "≈ 12 h (historia) · 21 h (completo)",
    fecha: "2027-12-31",
    estimado: true,
    fechaEstimada: "2027",
    plataformas: ["SWITCH2"],
    genero: ["AVENTURA", "SIMULACION", "DEPORTES"],
    desarrollador: "THE GAME BAKERS",
    descripcion: "Escalar una montaña que nadie subió, agarre por agarre, midiendo la resistencia y dónde poner cada mano. Lo hicieron los de Furi y Haven, y el eje es el mismo de siempre en ellos: una sola idea llevada hasta el fondo.",
    trailer: "https://youtube.com/embed/wqNfImlqR_I",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cobdqk.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    id: "danganronpa-2x2",
    titulo: "DANGANRONPA 2X2",
    fecha: "2027-01-14",
    plataformas: ["PS5"],
    genero: ["NOVELA VISUAL", "AVENTURA", "ANIME", "POINT AND CLICK"],
    desarrollador: "SPIKE CHUNSOFT",
    descripcion: "La vuelta de Danganronpa después de años, con la fórmula intacta: un grupo encerrado, un asesinato y un juicio donde hay que señalar al culpable con las pruebas en la mano. Spike Chunsoft le puso fecha para el 14 de enero de 2027.",
    trailer: "https://youtube.com/embed/kaYwJ6wq5cs",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocv93.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    ...
    fecha: "2027-01-28",
    plataformas: ["PS5"],
    genero: ["HORROR", "AVENTURA", "NOVELA VISUAL"],
    desarrollador: "BALLISTIC MOON",
    descripcion: "La secuela del terror de decisiones de 2015, donde cada elección define quién llega vivo al final y quién no. Sony la anunció en el State of Play de septiembre con fecha para el 28 de enero de 2027.",
    trailer: "https://youtube.com/embed/uQQywJ1Hotk",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coctve.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    ...
    titulo: "FATE/EXTRA RECORD",
    fecha: "2027-01-28",
    plataformas: ["PS5", "PS4"],
    genero: ["RPG", "ANIME", "POR TURNOS"],
    desarrollador: "TYPE-MOON",
    descripcion: "El rehecho de Fate/EXTRA, el RPG de PSP de 2010 donde se pelea una Guerra del Santo Grial dentro de una escuela virtual. Sale el 28 de enero de 2027 en PS5 y PS4.",
    trailer: "https://youtube.com/embed/nr5-XGIkbg4",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coctkz.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    ...
    fecha: "2027-02-04",
    plataformas: ["PS5", "XBOX"],
    genero: ["FPS", "SHOOTER", "SUPERVIVENCIA", "HORROR"],
    desarrollador: "4A GAMES",
    descripcion: "Lo nuevo de 4A Games en el metro de Moscú posnuclear. Sigue la línea de Exodus —tiros, sigilo y administrar máscaras y filtros— y se mostró jugado en PS5 Pro en el State of Play de septiembre. Sale el 4 de febrero de 2027.",
    trailer: "https://youtube.com/embed/5ohnFnJwWjI",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cobxor.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    id: "atelier-karia",
    titulo: "ATELIER KARIA: EL REINO DE LA NOCHE Y LA GUÍA DE LOS RECUERDOS",
    fecha: "2027-02-25",
    plataformas: ["PS5", "XBOX"],
    genero: ["RPG", "ANIME", "AVENTURA"],
    desarrollador: "GUST",
    descripcion: "Una entrega nueva de Atelier, la saga de alquimia de Gust donde se juntan materiales, se combinan en recetas y con eso se pelea. Koei Tecmo le puso fecha para el 25 de febrero de 2027.",
    trailer: "https://youtube.com/embed/JNI_kUOcZnM",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocuv0.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    ...
    titulo: "WO LONG 2: WINGS OF EMBER",
    fecha: "2027-03-04",
    plataformas: ["PS5", "XBOX"],
    genero: ["ACCION", "RPG", "AVENTURA"],
    desarrollador: "TEAM NINJA",
    descripcion: "La secuela de Wo Long: Fallen Dynasty, otra vez un RPG de acción exigente de Team Ninja en la China de los Tres Reinos. Un guerrero con el poder del fénix pelea contra generales y demonios con artes marciales acrobáticas, y el combate sigue girando alrededor de desviar ataques. La novedad son campos de batalla abiertos, armados sobre las batallas más famosas de la época.",
    trailer: "https://youtube.com/embed/6e6lN24jpA0",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocjkb.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-16"
  },
  ...
  },
  {
    ...
    titulo: "DRAGON BALL XENOVERSE 3",
    fecha: "2027-12-31",
    estimado: true,
    fechaEstimada: "2027",
    plataformas: ["PS5", "XBOX"],
    genero: ["LUCHA", "ANIME", "ACCION", "RPG"],
    desarrollador: "DIMPS",
    descripcion: "La tercera parte de Xenoverse, donde se arma un personaje propio y se pelea dentro de la historia de Dragon Ball corrigiendo lo que alguien alteró. Bandai Namco confirmó 2027 y todavía no dio día.",
    trailer: "https://youtube.com/embed/912l6NX5lrY",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coby8b.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    ...
    fechaEstimada: "2027",
    plataformas: ["PS5"],
    genero: ["ACCION", "RPG", "MUNDO ABIERTO"],
    desarrollador: "TRIPWIRE INTERACTIVE",
    descripcion: "La secuela del RPG en el que sos un tiburón: se come, se crece y se vuelve a la zona donde te fue mal a devolver el favor. Esta vez el escenario es el reino de Neptuno. Tripwire confirmó 2027, sin día.",
    trailer: "https://youtube.com/embed/3GLGzZHzzQE",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coctj8.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-09"
  },
  {
    id: "muramasa-revenant-blades",
    titulo: "MURAMASA: REVENANT BLADES",
    fecha: "2027-02-04",
    plataformas: ["PS5"],
    genero: ["ACCION", "RPG", "ANIME"],
    desarrollador: "VANILLAWARE",
    descripcion: "Vanillaware vuelve al Japón mitológico de Muramasa: The Demon Blade, aquel de Wii, con el mismo combate de desplazamiento lateral y espadas malditas que hay que ir cambiando en pleno golpe. Lo que sostiene a la saga es el dibujo hecho a mano, que es la marca del estudio desde Odin Sphere. Marvelous le puso fecha para el 4 de febrero de 2027.",
    trailer: "https://youtube.com/embed/mKXPyW8r4x8",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coc7m1.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-10"
  },
  ...
  {
    id: "moros-protocol",
    titulo: "MOROS PROTOCOL",
    relanzamiento: "En PC desde septiembre de 2025",
    duracion: "≈ 7 h (historia) · 20 h (completo)",
    fecha: "2026-10-01",
    plataformas: ["PS5", "SWITCH2"],
    genero: ["ACCION", "FPS", "ROGUELIKE", "COOP", "INDIE"],
    desarrollador: "PIXEL REIGN",
    descripcion: "Un shooter en primera persona que se despierta sin memoria dentro del Orpheus, un buque de guerra a la deriva en el espacio profundo. Se dispara y se patea al ritmo de los FPS de fines de los noventa, pero cada muerte reinicia la corrida y la nave se rearma con pasillos distintos. Los jefes son gigantes y están pensados a la manera de los Souls. Se puede jugar de a dos.",
    trailer: "https://youtube.com/embed/vHFTZnZa4-c",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1605250/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-11"
  },
  {
    id: "rally-hypercar-bundle",
    titulo: "RALLY & HYPERCAR BUNDLE",
    fecha: "2026-10-02",
    plataformas: ["SWITCH"],
    genero: ["CARRERAS","ARCADE"],
    desarrollador: "SUPERPOWERUPGAMES",
    descripcion: "Dos juegos de carreras en un paquete, uno de rally y otro de superdeportivos. Es de los baratos de la eShop, del mismo estudio que arma los Power Racing Bundle.",
    trailer: null,
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocm19.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-10"
  },
  {
    id: "screaming-halls-horror",
    titulo: "SCREAMING HALLS: HORROR",
    fecha: "2026-10-02",
    plataformas: ["SWITCH"],
    genero: ["HORROR","ACCION","ARCADE","INDIE"],
    desarrollador: "DOWNMEADOWSTREET",
    descripcion: "Terror de pasillos que no terminan nunca: se avanza por corredores que se repiten con variaciones y hay que notar qué cambió para salir. Corto y de sustos directos.",
    trailer: null,
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocq0l.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-10"
  },
  {
    id: "heroic-songs-the-remix",
    titulo: "HEROIC SONGS: THE REMIX!",
    fecha: "2026-10-08",
    plataformas: ["SWITCH"],
    genero: ["SIMULACION","MUSICA","ANIME"],
    desarrollador: "FRONTIER WORKS",
    descripcion: "Mitad construcción de ciudad, mitad manejo de ídolas: se levanta un santuario en mundos de fantasía y se administra al grupo que canta ahí. Estética de anime y bucle de gestión.",
    trailer: "https://youtube.com/embed/mJwjH73KwEM",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/coaiqr.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-10"
  },
  {
    id: "rainbow-islands-cs",
    titulo: "RAINBOW ISLANDS CS",
    relanzamiento: "El original de arcade es de 1987 — esta edición junta seis versiones distintas",
    fecha: "2026-10-08",
    plataformas: ["SWITCH"],
    genero: ["ARCADE","PLATAFORMA","RETRO"],
    desarrollador: "TAITO",
    descripcion: "La secuela de Bubble Bobble, el plataformas de subir haciendo arcoíris que sirven de escalón y de arma. Esta edición trae seis versiones del juego, de la de arcade a las conversiones caseras de la época.",
    trailer: null,
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/co6it5.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-10"
  },
  {
    id: "horse-club-ride-west",
    titulo: "HORSE CLUB RIDE WEST",
    fecha: "2026-10-09",
    plataformas: ["SWITCH", "PS5", "XBOX"],
    genero: ["AVENTURA","SIMULACION","CASUAL"],
    desarrollador: "WILD RIVER GAMES",
    descripcion: "Un juego de caballos ambientado en un rancho del oeste: se cuida al animal, se sale a cabalgar y se cumplen encargos por el mapa. Está apuntado a chicos.",
    trailer: "https://youtube.com/embed/HX-3ES4iO68",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocmgj.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-10"
  },
  {
    ...
    descripcion: "Un plataformas en tres dimensiones donde el protagonista es una tostada que se unta cosas encima para conseguir habilidades: dulce de leche para pegarse a las paredes, mermelada para rebotar. La idea entera sale de ahí.",
  ...
  {
    id: "fatal-fury-city-of-the-wolves-switch-2",
    titulo: "FATAL FURY: CITY OF THE WOLVES",
    relanzamiento: "En PS5, PS4, Xbox y PC desde abril de 2025 — esta fecha corresponde a la edición de Switch 2",
    duracion: "≈ 6,7 h (historia) · 25 h (completo)",
    fecha: "2026-10-22",
    plataformas: ["SWITCH2"],
    genero: ["LUCHA","ARCADE"],
    desarrollador: "SNK",
    descripcion: "La vuelta de Fatal Fury después de veintiséis años, ahora en Switch 2. Pelea uno contra uno en South Town con el sistema REV, que premia atacar sin parar pero castiga pasarse de rosca. Rock Howard vuelve a estar en el centro.",
    trailer: "https://youtube.com/embed/ZjjeJMy21Wg",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/co9z8m.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-10"
  },
  {
    id: "warrior-cats-clans-of-the-forest",
    titulo: "WARRIOR CATS: CLANS OF THE FOREST",
    fecha: "2026-10-23",
    plataformas: ["SWITCH2","SWITCH","PS5"],
    genero: ["ACCION","AVENTURA","RPG"],
    desarrollador: "TRAILMARK GAMES",
    descripcion: "Basado en Los gatos guerreros, la saga de libros: se juega como un gato de clan, se caza, se pelea por el territorio y se sube de rango. Mundo abierto de bosque con estaciones y jerarquía entre clanes.",
    trailer: "https://youtube.com/embed/NlB8mR-bd6E",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocmt9.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-10"
  },
  {
    id: "the-seance-of-blake-manor",
    titulo: "THE SÉANCE OF BLAKE MANOR",
    fecha: "2026-10-27",
    plataformas: ["SWITCH2"],
    genero: ["AVENTURA","PUZZLE","HORROR"],
    desarrollador: "RAW FURY",
    descripcion: "Una investigación en una mansión apartada donde pasa algo que no se explica solo. Se recorre, se junta evidencia y se arma qué pasó, con sesiones de espiritismo de por medio. Lo publica Raw Fury.",
    trailer: "https://youtube.com/embed/lKI7DVrhWL8",
    metacritic: null,
    imagen: "https://cdn2.steamgriddb.com/grid/4b21069e4de1d75b74640d2691e9f2d7.png",
    gamepass: false,
    psplus: false,
    alta: "2026-09-10"
  },
  ...
  {
    id: "tmnt-arcade-wrath-of-the-mutants-switch-2",
    titulo: "TMNT ARCADE: WRATH OF THE MUTANTS",
    duracion: "≈ 1,2 h (historia) · 7 h (completo)",
    relanzamiento: "En consolas y PC desde abril de 2024, y en salas de arcade desde 2017 — esta fecha corresponde a la edición de Switch 2",
    fecha: "2026-10-09",
    plataformas: ["SWITCH2"],
    genero: ["ACCION", "ARCADE", "COOP", "RETRO"],
    desarrollador: "CRADLE GAMES",
    descripcion: "El beat 'em up de las Tortugas que salió en las salas de arcade en 2017 y pasó a consolas en 2024, ahora en Switch 2. Se juega con Leonardo, Michelangelo, Donatello o Raphael, en cooperativo local, y está declaradamente inspirado en Turtles in Time. La versión de consola agregó tres niveles y seis peleas contra jefes que el original no tenía.",
    trailer: "https://youtube.com/embed/K9iBGnKyKOk",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2527580/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-03"
  },
  {
    id: "fading-echo-consolas",
    titulo: "FADING ECHO",
    relanzamiento: "En PC desde julio de 2026 y en Switch 2 desde el 17 de septiembre — esta fecha corresponde a las ediciones de PS5 y Xbox",
    duracion: "≈ 6,5 h (historia)",
    fecha: "2026-09-22",
    plataformas: ["PS5", "XBOX"],
    genero: ["ACCION", "AVENTURA", "RPG", "INDIE"],
    ...
    noticias: [
      {
        fecha: "2026-09-18",
        titulo: "YA ESTÁ EN PS5 Y XBOX",
        texto: "Salió el 22 de septiembre en PS5 y en Xbox Series, cinco días después de la edición de Switch 2. El blog de PlayStation lo anunció ese mismo día y en la PlayStation Store ya está a la venta."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    id: "sandwalkers",
    titulo: "SANDWALKERS",
    relanzamiento: "En PC desde abril de 2025 — esta fecha corresponde a la edición de Xbox",
    fecha: "2026-09-24",
    plataformas: ["XBOX"],
    genero: ["RPG", "ESTRATEGIA", "POR TURNOS", "ROGUELIKE", "INDIE"],
    desarrollador: "GOBLINZ STUDIO",
    descripcion: "Un roguelike de exploración por turnos. Cada diez años la tribu mka manda caravanas al Phithi, el caos climático que mantiene aisladas entre sí a las tribus de Uwando, con la misión de comerciar, reclamar tierras y plantar un árbol ciudad nuevo que sirva de refugio. Se recluta a cuatro personajes, cada uno con su clase y su habilidad, y se atraviesan lluvia ácida, tormentas, olas de calor, piratas y monstruos.",
    trailer: "https://youtube.com/embed/UrF5e97ulTQ",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1639080/library_600x900.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-20"
  },
  {
    id: "neon-abyss-2",
    titulo: "NEON ABYSS 2",
    relanzamiento: "En PC, en acceso anticipado, desde julio de 2025 — esta fecha es la de la versión terminada y la de consolas",
    duracion: "≈ 4 h (historia)",
    fecha: "2026-10-08",
    plataformas: ["PS5", "XBOX", "SWITCH"],
    genero: ["ACCION", "ROGUELIKE", "PLATAFORMA", "COOP", "INDIE"],
    desarrollador: "VEEWO GAMES",
    descripcion: "La secuela del roguelike de acción en dos dimensiones. Se baja por el abismo disparando y juntando objetos que se combinan entre sí, y de esas combinaciones sale cada partida. Suma cooperativo en línea para cuatro, con la opción de separarse por salas distintas, y más estilos de combate que el primero.",
    trailer: "https://youtube.com/embed/ZNjygOzJqMQ",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2235200/library_600x900.jpg",
    noticias: [
      {
        fecha: "2026-09-20",
        titulo: "SALE EL 8 DE OCTUBRE",
        texto: "Veewo Games y Kepler Interactive pusieron fecha en el PC Gaming Show: Tokyo Direct. El juego deja el acceso anticipado de PC ese mismo día y llega a PS5, Xbox y Switch."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    ...
    titulo: "WE WERE HERE TOMORROW",
    fecha: "2026-10-20",
    plataformas: ["PS5", "XBOX"],
    genero: ["PUZZLE", "AVENTURA", "COOP", "INDIE"],
    desarrollador: "TOTAL MAYHEM GAMES",
    descripcion: "El capítulo nuevo de la serie de puzles cooperativos para dos. Una expedición para rescatar a otros exploradores termina con la pareja atrapada bajo el hielo de la Antártida, y al despertar están en unas instalaciones de Norček Industries, donde el equipo que trabajaba ahí desapareció. Casi siempre separados, los dos se comunican por walkie-talkie: cada uno ve una parte del problema y tiene que describirla para que el otro pueda resolverlo.",
    trailer: "https://youtube.com/embed/JaB-nrBJFYo",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2315050/library_600x900.jpg",
    noticias: [
      {
        fecha: "2026-09-20",
        titulo: "SALE EL 20 DE OCTUBRE",
        texto: "Total Mayhem Games puso fecha en el PC Gaming Show: Tokyo Direct. Sale el mismo día en PC, PS5 y Xbox."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    id: "mycopunk",
    titulo: "MYCOPUNK",
    relanzamiento: "En PC, en acceso anticipado, desde julio de 2025 — esta fecha es la de la versión terminada y la de PS5",
    fecha: "2026-10-20",
    plataformas: ["PS5"],
    genero: ["ACCION", "SHOOTER", "FPS", "COOP", "INDIE"],
    desarrollador: "PIGEONS AT PLAY",
    descripcion: "Un shooter en primera persona de misiones y botín para hasta cuatro. Un grupo de robots descartados es contratado por la corporación SAXON para frenar una catástrofe de hongos que se extiende por todo el planeta. Las armas se mejoran en una grilla que deja armar combinaciones propias, y los enemigos van corrompiendo la tecnología del lugar para usarla en contra del equipo.",
    trailer: "https://youtube.com/embed/uggR1kFcdck",
    metacritic: null,
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3247750/library_600x900.jpg",
    noticias: [
      {
        fecha: "2026-09-20",
        titulo: "SALE DEL ACCESO ANTICIPADO EL 20 DE OCTUBRE",
        texto: "Devolver Digital puso fecha en el PC Gaming Show: Tokyo Direct. Ese día llega la versión terminada, y con ella el debut en PS5."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  {
    id: "lufia-i-ii-the-sinistrals-saga",
    titulo: "LUFIA I & II: THE SINISTRALS SAGA",
    relanzamiento: "Recopilación de dos JRPG de los noventa, con ajustes para jugarlos hoy",
    fecha: "2027-12-31",
    estimado: true,
    fechaEstimada: "2027",
    plataformas: ["PS5", "SWITCH2", "SWITCH"],
    genero: ["RPG", "POR TURNOS", "RETRO"],
    desarrollador: "TAITO",
    descripcion: "Los dos Lufia de los noventa en una sola entrega. En Lufia & the Fortress of Doom, un joven descendiente de un héroe legendario y una chica marcada por el destino cargan con lo que les tocó. Lufia II: Rise of the Sinistrals es una precuela y cuenta la historia de Maxim, el que después sería ese héroe, y sus compañeros.",
    trailer: "https://youtube.com/embed/_l-QB7iN4pc",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocy5a.jpg",
    noticias: [
      {
        fecha: "2026-09-20",
        titulo: "TAITO ANUNCIÓ LA RECOPILACIÓN",
        texto: "Se presentó en el PC Gaming Show: Tokyo Direct, para PS5, Switch 2, Switch y PC, con 2027 como fecha. La edita Clear River Games y por ahora la única ficha de tienda es la de la PlayStation Store."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  {
    id: "console-archives-karate-champ",
    titulo: "CONSOLE ARCHIVES: KARATE CHAMP",
    relanzamiento: "La versión hogareña de Data East es de 1986 — esta es la reedición para consolas actuales",
    fecha: "2026-09-24",
    plataformas: ["PS5"],
    genero: ["LUCHA", "RETRO", "ARCADE"],
    desarrollador: "HAMSTER",
    descripcion: "La línea Console Archives reedita el Karate Champ de 8 bits que Data East sacó en 1986: combates de karate a puntos, donde cada golpe se saca con combinaciones simples del control y los movimientos bien ejecutados son los que suman. Se juega de a uno o de a dos, y trae guardar en cualquier momento y controles configurables. El texto del juego está sólo en inglés. Sale a 7,99 dólares.",
    trailer: "https://youtube.com/embed/tVQ_DONwhy4",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/co7q8d.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-24"
  },
  {
    id: "arcade-archives-2-xevious-3d-g",
    titulo: "ARCADE ARCHIVES 2: XEVIOUS 3D/G",
    relanzamiento: "El original de NAMCO salió en los arcades en 1996 — esta es la reedición para consolas actuales",
    fecha: "2026-09-24",
    plataformas: ["PS5", "XBOX"],
    genero: ["SHOOTER", "ARCADE", "RETRO", "COOP"],
    desarrollador: "HAMSTER",
    descripcion: "El Xevious de los arcades rehecho en polígonos, que NAMCO sacó en 1996: el matamarcianos vertical de siempre, pero con cámaras que cambian de ángulo, armas y enemigos nuevos y siete zonas, entre ellas el desierto con el geoglifo y la fortaleza espacial. Se juega de a uno o de a dos. La línea Arcade Archives 2 suma rebobinado, ranuras de guardado, tablas de puntaje en línea y un modo contrarreloj. Sale a 16,99 dólares.",
    trailer: "https://youtube.com/embed/7e1ub85dsyk",
    metacritic: null,
    imagen: "https://images.igdb.com/igdb/image/upload/t_cover_big_2x/cocvjc.jpg",
    gamepass: false,
    psplus: false,
    alta: "2026-09-24"
  },
  {
    ...
    descripcion: "Un juego de acción en mundo abierto en la Tierra Media. Talion pelea por Mordor ligado a un espíritu cuya verdad hay que descubrir, y en el camino aparecen los orígenes de los Anillos de Poder, hasta llegar a enfrentar a Sauron. Lo que lo hizo famoso es el sistema Némesis, que le da a cada orco enemigo su propia historia con el jugador. La edición trae el contenido que salió después.",
    trailer: "https://youtube.com/embed/bq2P2VvFTMg",
    metacritic: 84,
  ...
  },
  {
    ...
    desarrollador: "MONOLITH PRODUCTIONS",
    descripcion: "La secuela de Shadow of Mordor. Talion forja un nuevo Anillo de Poder, arma su propio ejército de orcos para conquistar fortalezas en batallas grandes y enfrenta a Sauron y a los Nazgûl. El sistema Némesis vuelve más grande, con historias propias para cada enemigo y cada seguidor. La edición definitiva trae todo el contenido que salió después.",
    trailer: "https://youtube.com/embed/HmIdzplCp-o",
    metacritic: 80,
  ...
  },
  {
    ...
    desarrollador: "MANTIS",
    descripcion: "Un roguelike de construcción de mazos donde se juega del lado de la casa embrujada. De día se diseña el laberinto de la mansión y de noche se atrae a los visitantes y se usan cartas para convocar espíritus, mover pasillos y asustarlos hasta quebrarlos, mientras se protege el corazón de la casa. Con lo que se les saca, la casa crece y atrae enemigos más peligrosos.",
    trailer: "https://youtube.com/embed/ZBtX20ivIZQ",
    metacritic: 73,
    critica: "El puntaje es el de la versión de PC, de 2025. Las reseñas celebran la idea de ser la casa embrujada y la parte de construir la mansión, que para varias es lo más divertido, además de cartas creativas. Los reparos: la historia es casi inexistente, la tensión no escala, se depende mucho del azar de las cartas y a la larga se vuelve repetitivo.",
    imagen: "https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3179730/library_600x900.jpg",
    noticias: [
      {
        fecha: "2026-09-24",
        titulo: "SALE EL 8 DE OCTUBRE EN PS5 Y XBOX",
        texto: "DANGEN Entertainment lo confirmó para el 8 de octubre en PS5, Xbox Series y Xbox One, y también anunció versiones de Switch y Switch 2 que la eShop todavía no lista."
      }
    ],
    gamepass: false,
    psplus: false,
  ...
  },
  {
    id: "beamng-drive",
    titulo: "BEAMNG.DRIVE",
    relanzamiento: "En PC, en acceso anticipado, desde mayo de 2015 — esta fecha corresponde a la edición de PS5, que también sale en acceso anticipado",
    fecha: "2026-10-19",
    plataformas: ["PS5"],
    genero: ["SIMULACION", "CARRERAS"],
    desarrollador: "BEAMNG",
    descripcion: "Un simulador de manejo basado en física de cuerpos blandos: los vehículos se deforman como uno real cuando chocan. Más que un juego de carreras es un arenero para manejar, probar y romper.",
  ...
  },
  {
    ...
    descripcion: "Un RPG de acción y disparos con vista cenital en un mundo ciberpunk, para jugar solo o en cooperativo. En la arcología de The Ascent Group, en el planeta Veles, se juega con un trabajador esclavizado por la corporación que es dueña de todo. Cuando la empresa quiebra de un día para el otro, el distrito queda librado a su suerte. La Ultimate Edition trae todo el contenido que salió después.",
    trailer: "https://youtube.com/embed/N5kV5m1uR7A",
    metacritic: 74,
  ...
  {
    id: "eternal-anima",
    titulo: "ETERNAL ANIMA",
    fecha: "2027-03-04",
    plataformas: ["PS5"],
    genero: ["RPG", "POR TURNOS", "ANIME"],
    desarrollador: "MARVELOUS",
    descripcion: "Un JRPG por turnos de Marvelous. Wade puede leer los recuerdos que quedan guardados en los objetos, y con esa habilidad viaja entre el pasado y el presente para descubrir una historia olvidada. De esos recuerdos también salen clases y habilidades que se combinan libremente, y en combate se puede ver lo que va a hacer el enemigo y cambiarlo.",
  ...
  },
  {
    ...
    descripcion: "Un RPG de acción para un jugador, de ciencia ficción, en un universo nuevo que publica Wizards of the Coast. Se arranca como recolector de chatarra y se llega a Viajero, recorriendo mundos arrasados por los efectos del tiempo en busca de la clave para que la humanidad sobreviva.",

const JUEGOS = [
  ...
  },
  {
    ...
    descripcion: "AereA es un RPG de acción donde la música será tu mejor aliado y tu peor enemigo. Tu misión como discípulo del Gran Maestro Guido será desvelar los misterios de Aezir. Descubre qué ocurre y devuelve los nueve instrumentos esenciales para restaurar el equilibrio y devolver la paz al universo.",
  ...
  },
  {
    ...
    descripcion: "Lleva a tu gente a la victoria en un mundo cambiante en este juego estratégico con facciones asimétricas lideradas por grandes héroes. Erige tu imperio, ejerce influencia política y reúne ejércitos de guerreros para descubrir los oscuros secretos que alberga el planeta.",
  ...
  },
  {
    ...
    descripcion: "Ponte en la piel de Rick Grimes, Daryl Dixon y Michonne en un juego de lucha arcade ambientado en el universo de The Walking Dead de AMC. Enfréntate a enemigos despiadados como los Salvadores y a hordas de caminantes mientras realizas combos, ataques con armas distintivas y remates devastadores.",
  ...
  },
  {
    ...
    descripcion: "Siente la emoción de la caza y mantente alerta para descubrir las fantásticas especies salvajes que rondan por la naturaleza norteamericana y la sabana africana. Caza y exhibe tus piezas de caza mayor, como alces y búfalos cafre, y de caza menor y aves.",
  ...
  },
  {
    ...
    descripcion: "Take control of He-Man, Man-At-Arms, and Teela in a fast-paced, magic-brawler that blends the crunch of arcade classics with the high-fantasy action of the animated series.",
  ...
  },
  {
    ...
    descripcion: "Conviértete en el cazador inmortal y enfréntate al archidemonio Asmodeo. Ábrete paso entre oleadas de balas, mídete con jefes al estilo Souls, y aprovecha las bendiciones celestiales que transforman tus poderes en cada intento. Los demonios se alzan... es hora de empuñar tu espada.",
  ...
  },
  {
    ...
    descripcion: "Sé un CAMIONERO, no un camión. Transporta mercancías, restaura una ciudad olvidada y haz crecer tu negocio de transporte en el primer RPG auténtico sobre camiones. Sal a la calle para forjar relaciones y luego vuelve a subirte a tu camión totalmente personalizable para dominar la carretera.",
  ...
  },
  {
    ...
    descripcion: "Resuelve puzles de lógica y desentraña varios casos en un Londres noir y acogedor usando el razonamiento, no las conjeturas. Se han cometido asesinatos, los testimonios se contradicen y las coartadas no cuadran. Todos tienen un motivo, y solo la lógica clara revela la verdad.",
